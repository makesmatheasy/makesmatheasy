...
(function () {
  ...
  var __ = (core.Solve = {
    ...
    solveSystem: function (eqns, var_array) {
      ...
      if (typeof var_array === "undefined") {
        ...
        if (!_A.allLinear(eqns)) return __.solveNonLinearSystem(eqns);
  ...
  var solve = function (eqns, solve_for, solutions, depth) {
    ...
    if (eqns instanceof Equation) {
      ...
      if (eqns.isZero()) return [new Symbol(0)];
    ...
    var add_to_result = function (r, has_trig) {
      ...
      if (isArray(r)) {
        ...
        if (r.valueOf() !== "null") {
          ...
          if (!existing[r_str]) solutions.push(r); /*NO*/
    ...
    var eq = (core.Utils.isSymbol(eqns)
        ? eqns
        : __.toLHS(eqns, false)
      ).getNum(),
          ...
          if (vars[0] === solve_for) {
            ...
            if (!was_calculated) {
              ...
              if (deg === 1)
                ...
                var solutions = !factored.equals(eqns)
                  ? solve(factored, solve_for)
                  : [];
