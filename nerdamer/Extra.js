        ...
        if (symbol.isConstant() || !symbol.contains(t, true)) {
          ...
          if (
            ...
            if (depth_is_lower) {
              ...
              core.Settings.integration_depth =
                core.Settings.Laplace_integration_depth; //transforms need a little more room
            }
          ...
          function () {
            ...
            if (
              ...
              if (
                ...
                retval = _.parse(
                  format("(2*({2})*sqrt({0}))/({1})", t, f.a, b, num)
                );
                ...
                if (!num.contains(s)) {
                  ...
                  if (f2.x.isComposite()) {
                    ...
                    if (
                      ...
                      retval = _.parse(
                        format(exp, t, a, b, s_terms[0].b, f.a, f.b)
                      );
                    }
                  } else {
                    if (f2.x.isLinear()) {
