 ...
 */
        ...
        var buildHTML_checkPartialGroup = function checkPartialGroup(node) {
          if (
            ...
            (node instanceof domTree_Span && node.hasClass("enclosing"))
          ) {
            return node;
          }
        ...
        var delimiter_makeStackedDelim = function makeStackedDelim(
          ...
          if (
            ...
            var pathName =
              repeat === "\u239C" ? "leftParenInner" : "rightParenInner";
        ...
        var MacroExpander_MacroExpander =
          ...
          (function () {
            ...
            _proto.expandOnce = function expandOnce(expandableOnly) {
              ...
              var expansion = !topToken.noexpand
                ? this._getExpansion(name)
                : null;

              if (
                expansion == null ||
                (expandableOnly && expansion.unexpandable)
              ) {
                if (
                  expandableOnly &&
                  expansion == null &&
            ...
            _proto.expandMacro = function expandMacro(name) {
              return this.macros.has(name)
                ? this.expandTokens([new Token_Token(name)])
                : undefined;
            };
            /**
