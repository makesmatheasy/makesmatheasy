...
function squaresRangecal()
{
    ...
    if(num1=="" || num2=="")
    {
       s= "Please enter both numbers";
        ...
        print += "STEP2 : Print squares of &nbsp;"+ sqrt1 +"&nbsp; to &nbsp;"+ sqrt2 +"&nbsp; that comes under the range of &nbsp;"+ sqrt1+"&nbsp; and &nbsp;"+ sqrt2 +"&nbsp; <br> (including &nbsp;"+ sqrt1 +"&nbsp; and &nbsp;"+ sqrt2 +"&nbsp; both if their squares also are in range)<br>";
...
function cubesRangecal()
{
    ...
    if(num1=="" || num2=="")
    {
       s= "Please enter both numbers";
        ...
        print += "STEP2 : Print cubes of &nbsp;"+ cbrt1 +"&nbsp; to &nbsp;"+ cbrt2 +"&nbsp; that comes under the range of &nbsp;"+ cbrt1+"&nbsp; and &nbsp;"+ cbrt2 +"&nbsp; <br> (including &nbsp;"+ cbrt1 +"&nbsp; and &nbsp;"+ cbrt2 +"&nbsp; both if their cubes also are in range)<br>";
        for(var i=cbrt1; i<=cbrt2;i++){
            if(i**3>=num1 && i**3<=num2){
                var ans = i**3;
                pr +=ans.toString() + "   ";
