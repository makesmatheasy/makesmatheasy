        ...
        for (i = 0; i < arr.length; i++) {
            ...
            if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
                ...
                b.addEventListener("click", function(e) {
                    ...
                    else if (inp.value.toUpperCase() == "MARGIN OF ERROR CALCULATOR") {
                        $("#mecs").slideToggle();    
                    }
                    else if(inp.value.toUpperCase() == "MARGIN OF ERROR CALCULATOR"){
                        document.getElementById('mecs').click();
                    }      
                    else if (inp.value.toUpperCase() == "LOCATION OF ROOTS") {
                        $("#locroots").slideToggle();    
                    }
...
var arrayofelements =  ["Divide", "Integration","T test","Z test","Differentiation", "Laplace", "Inverse Laplace", "Multiplication Table", "Partial Differentiation", "Shapes", "Factors", "Matrix",
                        ...
                        "Trigonometric Values", "Power Series","Unit Converter" ,"Polynomial Degree","Set Calculator","GST Calculator","Representation by Power Series","EMI Calculator","Hydrostatic Pressure","3-D Geometry Calculator","Leap Year","Rank Calculator","Excess-3 Code Convertor","Linear Regression Calculator","Margin of Error Calculator","Improper to mixed Fraction","Location of roots","DIRECT AND INDIRECT PROPORTION","Covariance Calculator","Skewness Calculator","Solve For X","Grey Code Convertor","Bitwise Calculator","Boolean Algebra",
