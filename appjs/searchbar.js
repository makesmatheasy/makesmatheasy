        ...
        for (i = 0; i < arr.length; i++) {
            ...
            if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
                ...
                b.addEventListener("click", function(e) {
                    ...
                    else if (inp.value.toUpperCase() == "PERFECT SQUARES AND CUBES IN RANGES") {
                        $("#squaresRanges").slideToggle();    
                    }
                    else if(inp.value.toUpperCase() == "PERFECT SQUARES AND CUBES IN RANGES"){
                        document.getElementById('squaresRanges').click();
                    }      
                    else if (inp.value.toUpperCase() == "RESIDUE METHOD") {
                        $("#res").slideToggle();    
                    }
                    else if(inp.value.toUpperCase() == "RESIDUE METHOD"){
...
var arrayofelements =  ["Divide", "Integration","T test","Z test","Differentiation", "Laplace", "Inverse Laplace", "Multiplication Table", "Partial Differentiation", "Shapes", "Factors", "Matrix",
                        ...
                        "Trigonometric Values", "Power Series","Unit Converter" ,"Polynomial Degree","Set Calculator","GST Calculator","Representation by Power Series","EMI Calculator","Hydrostatic Pressure","3-D Geometry Calculator","Leap Year","Rank Calculator","Excess-3 Code Convertor","Linear Regression Calculator","Perfect Squares and Cubes in Range","Residue Method","Weighted Mean Calculator","Milne Thomson Method","Statistic Formulae","Covariance Calculator","Skewness Calculator","Solve For X","Grey Code Convertor","Bitwise Calculator","Boolean Algebra",
