      ...
      if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
        ...
        b.addEventListener("click", function (e) {
          ...
          if (inp.value.toUpperCase() == "INTEGRATION") {
            ...
            inp.value.toUpperCase() == "INVERSE AND PERIODICITY OF FUNCTIONS"
          ) {
            $("#ip").slideToggle();
          } else if (
            inp.value.toUpperCase() == "INVERSE AND PERIODICITY OF FUNCTIONS"
            ...
            inp.value.toUpperCase() == "INVERSE TRIGONOMETRIC IDENTITIES"
          ) {
            ...
            inp.value.toUpperCase() == "ALGEBRAIC EQUATIONS FORMULAS"
          ) {
            ...
            inp.value.toUpperCase() == "PROPERTIES OF PARALLEL LINES"
          ) {
            ...
            inp.value.toUpperCase() == "LAPLACE TRANSFORMS AND PROPERTIES"
          ) {
            $("#lappro").slideToggle();
          } else if (
            inp.value.toUpperCase() == "LAPLACE TRANSFORMS AND PROPERTIES"
            ...
            inp.value.toUpperCase() == "MAXIMA AND MINIMA OF FUNCTIONS"
          ) {
            $("#maxmin").slideToggle();
          } else if (
            inp.value.toUpperCase() == "MAXIMA AND MINIMA OF FUNCTIONS"
            ...
            inp.value.toUpperCase() == "BINARY/HEXADECIMAL CONVERTOR"
          ) {
            ...
            inp.value.toUpperCase() == "COORDINATE GEOMETRY CALCULATOR"
          ) {
            ...
            inp.value.toUpperCase() == "COORDINATE GEOMETRY FORMULA AND THEOREM"
          ) {
            $("#corgeo").slideToggle();
          } else if (
            inp.value.toUpperCase() == "COORDINATE GEOMETRY FORMULA AND THEOREM"
            ...
            inp.value.toUpperCase() == "SETS,RELATIONS AND FUNCTIONS"
          ) {
            $("#srf").slideToggle();
          } else if (
            inp.value.toUpperCase() == "SETS,RELATIONS AND FUNCTIONS"
            ...
            inp.value.toUpperCase() == "PROPERTIES OF MATRICES AND DETERMINANTS"
          ) {
            ...
            inp.value.toUpperCase() == "DEFINITE INTEGRATION FORMULAE"
          ) {
            ...
            inp.value.toUpperCase() == "CONVERGENCE AND DIVERGENCE OF SERIES"
          ) {
            $("#convdiv").slideToggle();
          } else if (
            inp.value.toUpperCase() == "CONVERGENCE AND DIVERGENCE OF SERIES"
            ...
            inp.value.toUpperCase() == "HYPERBOLIC TRIGONOMETRIC IDENTITIES"
          ) {
            ...
            inp.value.toUpperCase() == "SUM OF N TERMS OF AP,GP & HP"
          ) {
            $("#sum_n").slideToggle();
          } else if (
            inp.value.toUpperCase() == "SUM OF N TERMS OF AP,GP & HP"
            ...
            inp.value.toUpperCase() == "REPRESENTATION BY POWER SERIES"
          ) {
            $("#repp").slideToggle();
          } else if (
            inp.value.toUpperCase() == "REPRESENTATION BY POWER SERIES"
            ...
            inp.value.toUpperCase() == "PERFECT SQUARES & CUBES IN A RANGE"
          ) {
...
var arrayofelements = [
  ...
  "OPS1 on Complex Numbers",
  "OPS2 on Complex Numbers",
  "Properties",
  "Identities",
  "3-D Geometry",
...
function handleclick(value) {
  if (value.toUpperCase() == "INTEGRATION") {
    ...
    inp.value.toUpperCase() == "CAYLEY HAMILTON THEOREM AND DIAGONALIZATION"
  ) {
    $("#cay").slideToggle();
  } else if (
    inp.value.toUpperCase() == "CAYLEY HAMILTON THEOREM AND DIAGONALIZATION"
    ...
    inp.value.toUpperCase() == "GENERAL SOLUTION OF TRIGONOMETRIC EQUATIONS"
  ) {
    $("#trigsolcollapse").slideToggle();
  } else if (
    inp.value.toUpperCase() == "GENERAL SOLUTION OF TRIGONOMETRIC EQUATIONS"
    ...
    inp.value.toUpperCase() == "GREATEST INTEGER FUNCTION AND FRACTIONAL PART"
  ) {
    $("#giff").slideToggle();
  } else if (
    inp.value.toUpperCase() == "GREATEST INTEGER FUNCTION AND FRACTIONAL PART"
    ...
    inp.value.toUpperCase() == "CAUCHY INTEGRAL,LIOUVILLE AND ROUCHE THEOREM"
  ) {
    document.getElementById("clr").click();
  } else if (
    inp.value.toUpperCase() == "CAUCHY INTEGRAL,LIOUVILLE AND ROUCHE THEOREM"
...
function checkInput() {
  if (myInput.value.length != 0) return $("#search-txt").css("width", "240px");
