...
function additon() {
  ...
  if (
    document.getElementById("two_add").value == 0 ||
    document.getElementById("four_add").value == 0
  ) {
    document.getElementById("addz").innerHTML =
      "Your fraction is undefined because it has zero denominator";
    return;
  }
  if (
    Number.isNaN(d1) ||
...
function subtractiom() {
  ...
  if (
    document.getElementById("two_sub").value == 0 ||
    document.getElementById("four_sub").value == 0
  ) {
    document.getElementById("subz").innerHTML =
      "Your fraction is undefined because it has zero denominator";
    return;
...
function division() {
  ...
  if (
    document.getElementById("two_div").value == 0 ||
    document.getElementById("four_div").value == 0
  ) {
    document.getElementById("divaz").innerHTML =
      "Your fraction is undefined because it has zero denominator";
    return;
...
function multiplication1() {
  ...
  if (
    document.getElementById("two_mul").value == 0 ||
    document.getElementById("four_mul").value == 0
  ) {
    document.getElementById("mulz").innerHTML =
      "Your fraction is undefined because it has zero denominator";
    return;
