...
function cenextcal() {
  ...
  document.getElementById(
    "rcc"
  ).innerHTML = `The excentre for first side is ( ${excenteropx1} , ${excenteropy1} ) <br>`;
  document.getElementById(
    "rcc"
  ).innerHTML += `The excentre for second side is ( ${excenteropx2} , ${excenteropy2} ) <br>`;
  document.getElementById(
    "rcc"
  ).innerHTML += `The excentre for third side is ( ${excenteropx3} , ${excenteropy3} ) <br>`;
...
function solvesimpletrigo() {
  ...
  if (
    ...
    if (parseInt(hyp) < parseInt(pp) || parseInt(hyp) < parseInt(base)) {
      ...
      base != "" &&
      hyp != "" &&
      parseInt(hyp) ^ (2 != parseInt(pp)) ^ (2 + parseInt(base)) ^ 2 &&
      parseInt(hyp) ^ (2 != parseInt(base)) ^ (2 + parseInt(pp)) ^ 2
    ) {
      document.getElementById("soltri").innerHTML =
...
function fp() {
  ...
  if (giffnum >= 0) {
    ...
    document.getElementById("giffans").innerHTML =
      "The fractional part is " + ans;
  } else {
...
function parapipe() {
  ...
  var surfacearea =
    ...
    (parseInt(first) * parseInt(second) +
      ...
      parseInt(third) * parseInt(first));
  var diagonal = Math.sqrt(
    parseInt(first) ** 2 * parseInt(second) ** 2 * parseInt(third) ** 2
  );

  document.getElementById("volparapipe").innerHTML =
    "The volume is " + volume.toFixed(3);
  document.getElementById("saparapipe").innerHTML =
    "The Surface Area is " + surfacearea.toFixed(3);
  document.getElementById("diagparapipe").innerHTML =
    "The diagonal is " + diagonal.toFixed(3);
}
...
function findsecarea() {
  ...
  var ans = (r * r * ang) / 2;
  document.getElementById("secans1").innerHTML =
    "\\[The \\space area \\space of \\space sector \\space is \\space \\space \\frac{r^2\\theta}{2} \\space\\]";
  document.getElementById("secans2").innerHTML =
    "\\[\\frac{" +
    r +
    "^2\\times " +
    ang +
...
function ShowDistance() {
  ...
  explain.innerHTML =
    "\\[Distance \\space between \\space two \\space points =\\space \\sqrt{ (x1-x2)^2 + (y1-y2)^2 } \\] ";
  renderMathInElement(document.getElementById("dis_formula"));

  var distance = Math.sqrt(Math.pow(x1 - x2, 2) + Math.pow(y1 - y2, 2)).toFixed(
    2
  );
  document.getElementById("outPut").innerHTML =
...
function midpointsolve() {
  ...
  explain_mid.innerHTML =
    "\\[Midpoint \\space between \\space two \\space points =\\space  (\\frac{x1 + x2}{2}, \\space \\frac{y1+y2}{2} ) \\] ";
...
function interpointsolve() {
  ...
  explain.innerHTML =
    "\\[Intersection \\space point \\space  =\\space  (\\frac{b1 * c2 - b2 * c1}{a1 * b2 - a2 * b1}, \\space \\frac{a2 * c1 - a1 * c2}{a1 * b2 - a2 * b1} ) \\] ";
...
function anglesolve() {
  ...
  explain.innerHTML =
    "\\[Formula \\space = \\space tan^{-1}(\\frac{m2 - m1}{1+m1 \\times m2}) \\] ";
  ...
  document.getElementById("angle_output").innerHTML =
    "Angle between lines is " + ((angle * 180) / Math.PI).toFixed(1) + "&deg";
}
...
function dispointsolve() {
  ...
  explain.innerHTML =
    "\\[Distance \\space between \\space point \\space and \\space a \\space line  =\\space  \\frac{Ax1 + By1 + C}{\\sqrt{A^2+B^2}} \\] ";
...
function plpSolve() {
  ...
  var dis = b * x1 - a * y1;
  if (-a > 0)
    document.getElementById("plp_op").innerHTML =
...
function pppSolve() {
  ...
  var dis = a * x1 + b * y1;
  if (b > 0)
    document.getElementById("ppp_op").innerHTML =
...
function parallelsolve() {
  ...
  if (m1 == m2) {
    ...
    explain1.innerHTML =
      ...
      "( \\space x \\space - \\space " +
      x3 +
      ") \\space are \\space not \\space Parallel" +
      "\\] ";
...
function perpendicularsolve() {
  ...
  if (m1 * m2 == -1) {
    ...
    explain1.innerHTML =
      ...
      "( \\space x \\space - \\space " +
      x3 +
      ") \\space are \\space not \\space Perpendicular" +
      "\\] ";
    renderMathInElement(document.getElementById("line2"));
  }
}
...
function excentersolve() {
  ...
  var excenterop2 = (-a * x1 + b * y1 + c * z1) / (-a + b + c);
  document.getElementById("ex_output1").innerHTML =
    "The excentre for first side is " + excenterop1;
  document.getElementById("ex_output2").innerHTML =
    "The excentre for second side is " + excenterop2;
  document.getElementById("ex_output3").innerHTML =
    "The excentre for third side is " + excenterop3;
}
...
function collinearsolve() {
  ...
  if (mA == mB) {
    explainA.innerHTML =
      "\\[" + "Points \\space are \\space collinear" + "\\] ";
    renderMathInElement(document.getElementById("collop1"));
  } else {
    explainB.innerHTML =
      "\\[" + "Points \\space are \\space non-collinear" + "\\] ";
...
function displanesolve() {
  ...
  explain.innerHTML =
    "\\[Distance \\space from \\space point \\space to \\space plane \\space  =\\space  \\frac{Ax + By + Cz + D}{\\sqrt{A^2+B^2+C^2}} \\] ";
  renderMathInElement(document.getElementById("planept"));
  var dis =
    Math.abs(a * mx + b * my + c * mz + d) / Math.sqrt(a * a + b * b + c * c);
...
function solveocta() {
  ...
  if (a != "") {
    voltemp +=
      "\\[Volume \\space of \\space Octahedron \\space \\newline \\frac{\\sqrt{2}}{3} \\times" +
      a +
      "\\times" +
      a +
      "\\times" +
      a +
      "\\ = " +
      eval(String(0.471 * (a * a * a))).toFixed(3) +
      "\\]";
    voloutput.innerHTML = voltemp;

    tsatemp +=
      "\\[Surface \\space Area \\space of \\space Octahedron \\space \\newline " +
      2 +
      "\\times \\sqrt{3} " +
      "\\times" +
      a +
      ...
      a +
      "\\ = " +
      eval(String(3.464 * (a * a))).toFixed(3) +
      "\\]";
    tsaoutput.innerHTML = tsatemp;

    diagtemp +=
      "\\[Diagonal \\space of \\space Octahedron \\space \\newline \\sqrt{2} \\times " +
      a +
      "\\ = " +
      eval(String(1.414 * a)).toFixed(3) +
      "\\]";
...
function solvedodeca() {
  ...
  if (a != "") {
    voltemp +=
      "\\[Volume \\space of \\space Dodecahedron \\space \\newline \\frac{15 + 7 \\sqrt{5}}{4} \\times" +
      a +
      "\\times" +
      a +
      "\\times" +
      a +
      "\\ = " +
      eval(String(7.663 * (a * a * a))).toFixed(3) +
      "\\]";
    voloutput.innerHTML = voltemp;

    tsatemp +=
      "\\[Surface \\space Area \\space of \\space Dodecahedron \\space \\newline " +
      3 +
      "\\times \\sqrt{25 + 10 \\sqrt{5}} " +
      "\\times" +
      a +
      "\\times" +
      a +
      "\\ = " +
      eval(String(20.646 * (a * a))).toFixed(3) +
      "\\]";
    tsaoutput.innerHTML = tsatemp;
...
function solverhododeca() {
  ...
  if (a != "") {
    areatemp +=
      "\\[Surface \\space Area \\space of \\space Rhombic \\space \\newline Dodecahedron \\space \\newline " +
      8 +
      "\\times \\sqrt{2}" +
      "\\times" +
      a +
      ...
      a +
      "\\ = " +
      eval(String(11.31371 * a * a)).toFixed(3) +
      "\\]";
    areaoutput.innerHTML = areatemp;

    voltemp +=
      "\\[Volume \\space of \\space Rhombic \\space Dodecahedron \\space \\newline \\frac{16}{9} \\times \\sqrt{3}" +
      "\\times" +
      a +
      "\\times" +
      a +
      ...
      a +
      "\\ = " +
      eval(String(3.0792 * a * a * a)).toFixed(3) +
      "\\]";
    voloutput.innerHTML = voltemp;

    mrtemp +=
      "\\[Midsphere \\space radius \\space of \\space Rhombic \\space \\newline Dodecahedron \\space \\newline \\frac{2}{3} \\times \\sqrt{2}" +
      "\\times" +
      a +
      "\\ = " +
      eval(String(0.94281 * a)).toFixed(3) +
      "\\]";
    mroutput.innerHTML = mrtemp;

    irtemp +=
      "\\[Insphere \\space radius \\space of \\space Rhombic \\space \\newline Dodecahedron \\space \\newline \\frac{1}{3} \\times" +
      a +
      "\\times \\sqrt{6} " +
      "\\ = " +
      eval(String(0.8165 * a)).toFixed(3) +
      "\\]";
...
function angletwoplanesolve() {
  ...
  explain.innerHTML =
    "\\[Formula: \\space cos\\alpha = \\frac{|A1.A2  + B1.B2 + C1.C2 |}{\\sqrt{A1^2+B1^2+C1^2} \\times \\sqrt{A2^2+B2^2+C2^2}} \\] ";
  renderMathInElement(document.getElementById("angleplane"));
  var ang = Math.acos(
    Math.abs(a * a1 + b * b1 + c * c1) /
      Math.sqrt((a * a + b * b + c * c) * (a1 * a1 + b1 * b1 + c1 * c1))
  );

  document.getElementById("angleplaneop").innerHTML =
    "Angle between plane 1 and 2 is " +
...
function vectoradd() {
  ...
  var add2 = b + e;
  var add3 = c + f;
  document.getElementById("vectoradd1").innerHTML =
    "Sum of Vectors (X+Y) =  " +
    add1 +
    " i" +
    " + " +
...
function vectorsub() {
  ...
  document.getElementById("vsubi").innerHTML =
    "Difference between Vectors (X-Y) =  " + sub1;
  if (sub2 < 0) document.getElementById("vsubj").innerHTML = sub2;
  else document.getElementById("vsubj").innerHTML = "+" + sub2;
  if (sub3 < 0) document.getElementById("vsubk").innerHTML = sub3;
  else document.getElementById("vsubk").innerHTML = "+" + sub3;
}
function vectordot() {
  ...
  document.getElementById("vectordot1").innerHTML =
    "\\[ Dot \\space Product \\space of \\space Vectors \\space (X.Y) \\space =" +
    mult +
    "\\]";
...
function vectorcross() {
  ...
  ans2 = mul4 - mul5;
  if (ans1 < 0 && ans2 < 0) {
    document.getElementById("vectorcross1").innerHTML =
      "\\[  \\overrightarrow{X} \\space \\times \\space \\overrightarrow{Y} \\space = \\space \\hat{i} \\space (" +
      mul +
      "- \\space (" +
      mul1 +
      ")\\space) \\space - \\space \\hat{j} (" +
      mul2 +
      "- \\space (" +
      mul3 +
      ")\\space)\\space + \\space \\hat{k} (" +
      mul4 +
      "- \\space (" +
      mul5 +
      ") \\space )    \\]";
    document.getElementById("vectorcross2").innerHTML =
      "\\[ Cross \\space Product \\space of \\space Vectors \\space (X \\times Y) \\space = " +
      ans +
      "\\hat{i} \\space " +
      ans1 +
      "\\hat{j} \\space " +
...
function solveicosa() {
  ...
  if (a != "") {
    document.getElementById("resultofvolt").innerHTML =
      "\\[Volume \\space of \\space Icosahedron \\space \\newline \\frac{5}{12}" +
      "( \\space 3 \\space + \\space \\sqrt{5})" +
      a +
      "\\times" +
      a +
      "\\times" +
  ...
  if (a != "") {
    document.getElementById("resultoftsa").innerHTML =
      "\\[Surface \\space Area \\space of \\space Icosahedron \\space \\newline " +
      5 +
      "\\times \\sqrt{3} " +
      "\\times" +
      a +
...
function coordinatearea() {
  ...
  if (x1 != "" && y1 != "" && x2 != "" && y2 != "" && x3 != "" && y3 != "") {
    areaop.innerHTML =
      "\\[Area \\space = \\space " + area + "\\space sq. \\space units" + "\\]";
    renderMathInElement(document.getElementById("areaoutput"));
    explain.innerHTML =
      "\\[Formula \\space  =\\space  \\frac{1}{2}| \\space x1(y2-y3) \\space + x2(y3-y1) + x3(y1-y2) | \\] ";
...
function solvetwoplane() {
  ...
  if (a == a1 && b == b1 && c == c1) {
    ...
    document.getElementById("dplane").innerHTML =
      "Distance between plane 1 and 2 is " + res.toFixed(2);
  } else {
    document.getElementById("dplane1").innerHTML =
      "Planes are not parallel, so distance is 0";
  }
}
...
function solvetetra() {
  ...
  if (a != "") {
    document.getElementById("resultofvolt").innerHTML =
      "\\[Volume \\space of \\space Regular \\space Tetrahedron \\space \\newline \\frac{1}{6 \\sqrt{2}} \\times" +
      a +
      "\\times" +
      a +
      "\\times" +
  ...
  if (a != "") {
    document.getElementById("resultofheightt").innerHTML =
      "\\[Height \\space of \\space Regular \\space Tetrahedron \\space \\newline \\frac{\\sqrt{2}}{\\sqrt{3}} \\times (" +
      a +
      ")\\ = " +
      height.toFixed(3) +
      " \\]";
  ...
  if (a != "") {
    document.getElementById("resultofcircumt").innerHTML =
      "\\[CircumRadius \\newline \\space of \\space Regular \\space Tetrahedron \\space \\newline \\frac{\\sqrt{6}}{4} \\times (" +
      a +
      ")\\ = " +
      circum +
      " \\]";
  ...
  if (a != "") {
    document.getElementById("resultofsurare").innerHTML =
      "\\[Surface \\space Area \\newline \\space of \\space Regular \\space Tetrahedron \\space \\newline \\sqrt{3} \\times (" +
      a +
      ")^2\\ = " +
      area +
  ...
  if (a != "") {
    document.getElementById("resultofinradt").innerHTML =
      "\\[InRadius \\space of \\space Regular \\space Tetrahedron \\space \\newline \\frac{1}{\\sqrt{24}} \\times (" +
      a +
      ")\\ = " +
      inradius +
      " \\]";
    ...
    document.getElementById("resultofvolt").innerHTML =
      "Enter side a to calculate volume";
  }
}
...
function pythtriple() {
  ...
  if (num % 2 == 0) {
    ...
    document.getElementById("answ").innerHTML =
      "The triplets are " + nums + " ," + les + ", " + more;
  } else {
    var nums = parseInt(num);
...
function solverightangletriangle() {
  ...
  if (base != "" && height != "") {
    ...
    hypotemp +=
      "\\[Hypotenuse \\space of \\space Triangle \\space is \\space" +
...
function solvescalenetriangle() {
  ...
  if (sidea != "" && sideb != "" && sidec != "") {
    ...
    semiperitemp +=
      "\\[Semi-perimeter \\space of \\space Triangle \\space is \\space" +
    ...
    areatemp +=
      ...
      semiperimeter +
      "\\times" +
      eval(String(a2 * b2 * c2)) +
      "}\\]";
    areatemp += "\\[A = \\sqrt{ " + ans + " }\\]";
    areatemp += "\\[A=" + anssqrt + " \\]";
    areatemp +=
      "\\[Area \\space of \\space Triangle \\space is \\space " +
      anssqrt +
      "\\]";
    areaoutput.innerHTML = areatemp;
...
function isoscelestrianglearea() {
  ...
  var height = Math.sqrt(
    parseInt(eqside) * parseInt(eqside) - (parseInt(side) * parseInt(side)) / 4
  );
  var perimeter = 2 * parseInt(eqside) + parseInt(side);
  var area = 0.5 * side * height;
  if (side != "" && eqside != "") {
    document.getElementById("resultofheightit1").innerHTML =
      "\\[Height \\space of \\space the \\space Isosceles \\space triangle \\space is \\]";
    renderMathInElement(document.getElementById("resultofheightit1"));
    document.getElementById("resultofheightit2").innerHTML =
      "\\[\\sqrt{" +
      eval(eqside * eqside) +
      " \\space - \\frac{" +
      eval(side * side) +
    ...
    document.getElementById("resultofareait1").innerHTML =
      "\\[Area \\space of \\space the \\space Isosceles \\space triangle \\space is \\]";
    renderMathInElement(document.getElementById("resultofareait1"));
    document.getElementById("resultofareait2").innerHTML =
      "\\[\\frac{1}{2} \\times" +
      side +
      "\\times " +
      height.toFixed(2) +
    ...
    document.getElementById("resultofperiit1").innerHTML =
      "\\[Perimeter \\space of \\space the \\space Isosceles \\space triangle \\space is \\]";
    renderMathInElement(document.getElementById("resultofperiit1"));
    document.getElementById("resultofperiit2").innerHTML =
      "\\[2*(" + eqside + ") + " + side + "= " + perimeter + "\\]";
...
function isoscelesrightsolve() {
  ...
  if (side != "") {
    document.getElementById("resofisoarea1").innerHTML =
      "\\[Area \\space of \\space Isosceles \\space right \\space triangle \\space is \\]";
    renderMathInElement(document.getElementById("resofisoarea1"));
    document.getElementById("resofisoarea2").innerHTML =
      "\\[ \\frac{" + side + "\\times" + side + "}{4} =" + area + "\\]";
    renderMathInElement(document.getElementById("resofisoarea2"));
    document.getElementById("resofisoperi1").innerHTML =
      "\\[Perimeter \\space is \\]";
    renderMathInElement(document.getElementById("resofisoperi1"));
    document.getElementById("resofisoperi2").innerHTML =
      "\\[ (1 \\space + \\space \\sqrt{2})" +
      "\\times" +
      side +
      "=" +
      peri +
    ...
    document.getElementById("resofisoheight1").innerHTML =
      "\\[Height \\space is \\]";
    renderMathInElement(document.getElementById("resofisoheight1"));
    document.getElementById("resofisoheight2").innerHTML =
      "\\[ \\frac{1}{2} " + "\\times" + side + "=" + height + "\\]";
    renderMathInElement(document.getElementById("resofisoheight2"));
    document.getElementById("resofisobase1").innerHTML =
      "\\[Base \\space is \\]";
    renderMathInElement(document.getElementById("resofisobase1"));
    document.getElementById("resofisobase2").innerHTML =
      "\\[ \\frac{1}{\\sqrt{2}} " + "\\times" + side + "=" + base + "\\]";
...
function solvestriangle() {
  ...
  var peri =
    parseInt(s1) +
    parseInt(s2) +
    math.sqrt(s1 ** 2 + s2 ** 2 - 2 * s1 * s2 * math.cos(angle));

  if (height <= 0 && area <= 0 && s1 != "" && s2 != "" && angle != "") {
    document.getElementById("resultofper").innerHTML = "";
    document.getElementById("resultofarea").innerHTML =
      "Please enter correct angle";
    document.getElementById("resultofheight").innerHTML = "";
    return;
  }
  if (s1 != "" && s2 != "" && angle != "") {
    document.getElementById("resultofper").innerHTML =
      "The Perimeter of the triangle (P) = " + peri.toFixed(3);
    document.getElementById("resultofarea").innerHTML =
      "The Area of the triangle  (S) = " + area.toFixed(3);
    document.getElementById("resultofheight").innerHTML =
      "The Height of the traingle (h) = " + height.toFixed(3);
  }
}
...
function findeq() {
  ...
  document.getElementById("xeqn").innerHTML =
    "x &nbsp  =&nbsp; " + a1 + "√u/" + Math.sqrt(h1) + " cosv ";
  document.getElementById("yeqn").innerHTML =
    "y &nbsp;  =&nbsp; " + a1 + " √u/ " + Math.sqrt(h1) + " sinv ";
...
function solveparallelogramcal() {
  ...
  if (area <= 0 && base != "" && side != "" && angle != "") {
    ...
    document.getElementById("resultofperipar").innerHTML =
      "Please enter correct angle";
    return;
  }
  if (base != "" && side != "" && angle != "") {
    document.getElementById("resultofareapar").innerHTML =
      "The Area of the parallelogram  (S) = " + area.toFixed(3);
    document.getElementById("resultofperipar").innerHTML =
      "The Perimeter of the parallelogram (P) = " + peri.toFixed(3);
  }
}
...
function solveparallelogram() {
  ...
  console.log(h);
  if (base != "" && height != "") {
    document.getElementById("resultofareap").innerHTML =
      "\\[Area \\space of \\space  parallelogram \\space \\space" +
      base +
      "\\times" +
      height +
      "\\ = " +
  ...
  if (side != "" && base != "") {
    document.getElementById("resultofperip1").innerHTML =
      "\\[Perimeter \\space of \\space parallelogram\\]";
    renderMathInElement(document.getElementById("resultofperip1"));
    document.getElementById("resultofperip2").innerHTML =
      "\\[2 \\times (" + base + "+" + side + ")\\ = " + p + " \\]";
    renderMathInElement(document.getElementById("resultofperip2"));
  }
  if (base != "" && a != "") {
    document.getElementById("resultofheightp").innerHTML =
      "\\[Height \\space of \\space parallelogram  \\space \\frac{" +
      a +
      "}{" +
      base +
      "} = " +
...
function solvetrapezium() {
  ...
  if (value < 0 || value == 0) {
    document.getElementById("resultofareatrap1").innerHTML =
      "Please enter valid side values";
    ...
    document.getElementById("resultofareatrap1").innerHTML =
      "Enter all sides to calculate Height, Area and perimeter";
  } else if (a != "" && b != "" && c != "" && d != "") {
    heighttemp += "\\[Height=?\\]";
    heighttemp += "\\[Base\\space of\\space triangle = b-a\\]";
    heighttemp += "\\[Base\\space of\\space triangle = " + ts + "\\]";
    heighttemp +=
      "\\[Area\\space of\\space triangle = \\sqrt{s(s-base)(s-c)(s-d)} \\]";
    heighttemp +=
      "\\[A=\\sqrt{" +
      s +
      "(" +
    ...
    heighttemp +=
      "\\[Height= \\frac{2*Area\\space of\\space triangle}{base\\space of\\space triangle}\\]";
...
function rhombussolve() {
  ...
  var perimeter = 4 * a;
  if (d1 != "" && d2 != "") {
    document.getElementById("resultofareac").innerHTML =
      "\\[Area \\space of \\space Rhombus  \\space \\frac{1}{2} \\times" +
      d1 +
      "\\times" +
      d2 +
      "\\ = " +
  ...
  if (a != "") {
    document.getElementById(
      "resultofperi"
    ).innerHTML = `\\[Perimeter \\space of \\space Rhombus \\ 4 \\times${a}\\ = ${perimeter}\\]`;
    renderMathInElement(document.getElementById("resultofperi"));
  } else if (a == "") {
    document.getElementById("resultofperi").innerHTML =
      "Enter side value to calculate perimeter";
  }
}
...
function cycquadcal() {
  ...
  if (a != "" && b != "" && c != "" && d != "") {
    document.getElementById("resultofquads").innerHTML =
      "\\[s = \\frac{ " +
      a +
      " + " +
      b +
    ...
    if (area >= 0) {
      document.getElementById("resultofquadarea1").innerHTML =
        "\\[Area \\space(S) \\space of \\space Cyclic  \\space Quadrilateral \\space is \\]";
    ...
    document.getElementById("resultofquadperip1").innerHTML =
      "\\[Perimeter \\space of \\space Cyclic  \\space Quadrilateral \\space is \\]";
    document.getElementById("resultofquadperip2").innerHTML =
      "\\[2 \\times (" +
      a +
      "+" +
...
function Kitesolve() {
  ...
  var perimeter = 2 * sum;
  if (p != "" && q != "") {
    document.getElementById("resultofareaK").innerHTML =
      "\\[Area \\space of \\space Kite  \\space \\space \\frac{1}{2} \\times" +
      p +
      "\\times" +
      q +
      "\\ = " +
  ...
  if (a != "" && b != "") {
    document.getElementById("resultofperiK").innerHTML =
      "\\[Perimeter \\space of \\space Kite  \\space \\ 2 \\times (" +
      a +
      "+" +
      b +
      ")\\ = " +
    ...
    document.getElementById("resultofperiK").innerHTML =
      "Enter side a and b both to calculate perimeter";
  }
}
...
function solvecircle() {
  ...
  document.getElementById("resultofareacir").innerHTML =
    "\\[Area \\space of \\space Circle \\ 3.14 r^2\\ = " +
    area +
    "\\space cm^2 \\]";
  document.getElementById("resultofcircumferencec1").innerHTML =
    "\\[ 2*3.14 r \\ = " + Circumference + "\\]";
  document.getElementById("resultofcircumferencec2").innerHTML =
    "\\[Circumference \\space of \\space Circle \\space is \\space" +
    Circumference +
    "\\space cm\\]";
  document.getElementById("resultofdiameterc").innerHTML =
    "\\[Diameter \\space of \\space Circle \\ = " + diameter + "\\space cm\\]";
  document.getElementById("resultofchord").innerHTML =
    "\\[Length \\space of \\space the \\space Chord \\space is \\ = " +
    chord +
    "\\space cm \\]";
...
function solvesemicircle() {
  ...
  Circumference = Circumference.toPrecision(3);
  diameter = diameter.toPrecision(3);
  document.getElementById("resultofareasemi").innerHTML =
    "\\[Area \\space of \\space SemiCircle = \\frac{ 3.14r^2}{2}\\ = " +
    area +
    "\\]";
  document.getElementById("resultofcircumsemi").innerHTML =
    "\\[Circumference \\space of \\space Circle = \\ 3.14 r+2r \\ = " +
    Circumference +
    "\\]";
  document.getElementById("resultofdiasemi").innerHTML =
    "\\[Diameter\\space of \\space Circle = " + diameter + "\\]";
...
function solvecirclecal() {
  ...
  console.log(R);
  console.log(circum);
  document.getElementById("resultofradcircal").innerHTML =
    "\\[Radius \\space of \\space Circle = \\sqrt{\\frac{" +
    area +
    "}{\\pi}}\\ = " +
    r.toFixed(3) +
    "\\]";
  document.getElementById("resultofcircumcirccal").innerHTML =
    "\\[Circumference = \\pi \\times 2 \\times " +
    r.toFixed(2) +
    " \\ = " +
    circum.toFixed(3) +
    "\\]";
  document.getElementById("resultofdiacircal").innerHTML =
    "\\[Diameter\\space of \\space Circle = " + R.toFixed(3) + "\\]";
...
function solvepent() {
  ...
  if (side != "") {
    document.getElementById("resultofareapent1").innerHTML =
      "\\[Area \\space of \\space Pentagon \\space \\]";
    document.getElementById("resultofareapent2").innerHTML =
      "\\[\\frac{1}{4} \\sqrt{5(5 + 2 \\sqrt{5})} \\times " +
      side +
      "^2 = " +
      area.toFixed(2) +
      "\\]";
    document.getElementById("resultofdiagonalpent1").innerHTML =
      "\\[Daigonal \\space of \\space Pentagon \\space (d) \\]";
    document.getElementById("resultofdiagonalpent2").innerHTML =
      "\\[\\frac{1 + \\sqrt{5}}{2} \\times " +
      side +
      "=" +
      diagonal.toFixed(2) +
      "\\]";
    document.getElementById("resultofperimeterpent").innerHTML =
      "\\[Perimeter \\space of \\space Pentagon \\space 5 \\times " +
      side +
      " = " +
      perimeter +
      "\\]";
...
function solvedeca() {
  ...
  document.getElementById("resultofareadeca1").innerHTML =
    "\\[Area \\space of \\space Decagon \\space \\]";
  document.getElementById("resultofareadeca2").innerHTML =
    "\\[\\frac{5}{2} \\times" +
    side +
    "^2 \\sqrt(5 + 2\\sqrt{5}) = " +
    area.toFixed(2) +
    "\\]";
  document.getElementById("resultofperimeterdeca").innerHTML =
    "\\[Perimeter \\space of \\space Decagon \\space \\space  10 \\times " +
    side +
    " = " +
    perimeter +
    "\\]";
...
function solvehex() {
  ...
  document.getElementById("resultofareahex1").innerHTML =
    "\\[Area \\space of \\space Hexagon \\space \\]";
  document.getElementById("resultofareahex2").innerHTML =
    "\\[\\frac{3 \\sqrt{3}}{2} \\times " +
    side +
    "^2 = " +
    area.toFixed(2) +
    "\\]";
  document.getElementById("resultofperimeterhex").innerHTML =
    "\\[Perimeter \\space of \\space Hexagon \\space 6 \\times " +
    side +
    " = " +
    perimeter +
    "\\]";
...
function solvehept() {
  ...
  if (side != "") {
    ...
    areatemp +=
      ...
      side +
      "\\times" +
      "\\space cot(\\frac{180}{7} \\degree) \\space" +
      "=" +
      eval(String(3.63391 * side * side)).toFixed(2) +
      "\\]";
    areaoutput.innerHTML = areatemp;

    peritemp +=
      "\\[Perimeter \\space of \\space Heptagon \\space is \\space \\]";
    peritemp +=
      "\\[" + 7 + "\\times" + side + "=" + eval(String(7 * side)) + "\\]";
...
function solveoct() {
  ...
  document.getElementById("resultofareaoct1").innerHTML =
    "\\[Area \\space of \\space Octagon \\space \\]";
  document.getElementById("resultofareaoct2").innerHTML =
    "\\[2 \\times (1 + \\sqrt{2}) \\times " +
    side +
    "^2 = " +
    area.toFixed(2) +
    "\\]";
  document.getElementById("resultofperimeteroct").innerHTML =
    "\\[Perimeter \\space of \\space Octagon \\space \\space  8 \\times " +
    side +
    " = " +
    perimeter +
    "\\]";
...
function solvenona() {
  ...
  if (side != "") {
    ...
    areatemp +=
      ...
      side +
      "\\times" +
      "\\space cot(\\frac{180}{9} \\degree) \\space" +
      "=" +
      eval(String(6.18182 * side * side)).toFixed(2) +
      "\\]";
    areaoutput.innerHTML = areatemp;

    peritemp +=
      "\\[Perimeter \\space of \\space Nonagon \\space is \\space \\]";
    peritemp +=
      "\\[" + 9 + "\\times" + side + "=" + eval(String(9 * side)) + "\\]";
    perioutput.innerHTML = peritemp;
...
function solvepentagram() {
  ...
  if (a != "") {
    chordtemp +=
      "\\[Chord \\space length \\space of \\space Pentagram \\newline " +
      a +
      "\\times" +
      1.62 +
      "\\ = " +
      eval(String(1.61803399 * a)).toFixed(2) +
      "\\]";
    chordoutput.innerHTML = chordtemp;

    longchotemp +=
      "\\[Long \\space chord \\space slice \\space of \\space Pentagram \\space \\newline \\frac{1}{1.62}" +
      "\\times" +
      a +
      "\\ = " +
      eval(String(0.61803399 * a)).toFixed(2) +
      "\\]";
    longchordoutput.innerHTML = longchotemp;

    shochotemp +=
      "\\[Short \\space chord \\space slice \\space of \\space Pentagram \\space \\newline \\frac{1}{1.62} \\times \\frac{1}{1.62}" +
      "\\times" +
      a +
      "\\ = " +
      eval(String(0.38196601 * a)).toFixed(2) +
      "\\]";
    shortchordoutput.innerHTML = shochotemp;

    peritemp +=
      "\\[Perimeter \\space of \\space Pentagram \\space \\newline \\frac{10}{1.62} \\times" +
      a +
      "\\ = " +
      eval(String(6.18033989 * a)).toFixed(2) +
      "\\]";
    perioutput.innerHTML = peritemp;

    areatemp +=
      "\\[Area \\space of \\space Pentagram \\space \\newline \\frac{\\sqrt{5 \\times (5 - 2 \\sqrt{5})}}{2} \\times" +
      a +
      "\\times" +
      a +
      "\\ = " +
      eval(String(0.81229924 * a * a)).toFixed(2) +
      "\\]";
    areaoutput.innerHTML = areatemp;
...
function solveannulus() {
  ...
  if (radius1 != "" && radius2 != "") {
    area1temp +=
      "\\[" + "\\pi" + "\\times" + radius1 + "\\times" + radius1 + "\\]";
    area1temp +=
      "\\[Area \\space enclosed \\space by \\space Outer \\space circle \\space is \\space " +
      eval(String(3.14 * radius1 * radius1)) +
      "\\]";
    area1output.innerHTML = area1temp;
    area2temp +=
      "\\[" + "\\pi" + "\\times" + radius2 + "\\times" + radius2 + "\\]";
    area2temp +=
      "\\[Area \\space enclosed \\space by \\space Inner \\space circle \\space is \\space " +
      eval(String(3.14 * radius2 * radius2)) +
      "\\]";
    ...
    areatemp +=
      ...
      "\\]";
    areatemp +=
      "\\[Area \\space of \\space annulus \\space is \\space " +
      eval(String(3.14 * radius1 * radius1 - 3.14 * radius2 * radius2)) +
      "\\]";
    areaoutput.innerHTML = areatemp;
    circum1temp +=
      "\\[" + 2 + "\\times" + "\\pi " + "\\times" + radius1 + "\\]";
    circum1temp +=
      "\\[Outer \\space cicrumference \\space of \\space annulus \\space is \\space " +
      eval(String(3.14 * 2 * radius1)) +
      "\\]";
    circum1output.innerHTML = circum1temp;
    circum2temp +=
      "\\[" + 2 + "\\times" + "\\pi " + "\\times" + radius2 + "\\]";
    circum2temp +=
      "\\[Inner \\space cicrumference \\space of \\space annulus \\space is \\space " +
      eval(String(3.14 * 2 * radius2)) +
      "\\]";
...
function solveellipse() {
  ...
  if (a != "" && b != "") {
    ...
    anssqrt = eval(anssqrt).toFixed(3);
    perimetertemp +=
      "\\[P=\\sqrt{2}\\times \\pi \\sqrt{" + a + "^2" + "+" + b + "^2" + "}\\]";
    perimetertemp +=
      "\\[P=\\sqrt{2}\\times \\pi \\sqrt{" + a2 + "+" + b2 + "}\\]";
...
function solvecyl() {
  ...
  var tsa = eval(
    String(2 * 3.14159 * radius * height + 2 * 3.14159 * radius * radius)
  );
  ...
  if (radius != "" && height != "") {
    ...
    voltemp +=
      "\\[Volume \\space of \\space Cylinder \\space is \\space " +
      vol.toFixed(3) +
      "\\]";
    voloutput.innerHTML = voltemp;
    ...
    csatemp +=
      "\\[Curved \\space Surface \\space Area \\space of \\space Cylinder \\space is \\space \\]";
    ...
    diaout.innerHTML =
      "\\[Diameter \\space of \\space Cylinder \\space is \\space " +
      diameter.toFixed(3) +
      "\\]";
...
function solvehollowcyl() {
  ...
  if (radius1 != "" && radius2 != "" && height != "") {
    voltemp +=
      ...
      "\\]";
    voltemp +=
      "\\[Volume \\space of \\space hollow \\space hollow \\space Cylinder \\space is \\space " +
      eval(String(3.14159 * (radius1 * radius1 - radius2 * radius2) * height)) +
      "\\]";
    voloutput.innerHTML = voltemp;
    csatemp +=
      "\\[2 \\times \\pi \\times" +
      ...
      ") \\]";
    csatemp +=
      "\\[Curved \\space Surface \\space Area \\space of \\space hollow \\space Cylinder \\space is \\space \\]";
    csatemp +=
      "\\[" + eval(String(3.14159 * (radius1 + radius2) * 2 * height)) + "\\]";
    csaoutput.innerHTML = csatemp;
    tsatemp +=
      "\\[2 \\times \\pi \\times" +
      height +
    ...
    tsatemp +=
      ...
      eval(
        String(
          2 * 3.14159 * (radius1 + radius2) * height +
            2 * 3.14159 * (radius1 + radius2) * (radius1 - radius2)
        )
      ) +
      "\\]";
...
function obliquecysolve() {
  ...
  var volume =
    (3.14 * radius * radius * height1 + 3.14 * radius * radius * height2) / 2;
  ...
  var sa =
    ...
    3.14 *
      radius *
      Math.sqrt(
        radius * radius + ((height1 - height2) * (height1 - height2)) / 4
      );
  if (radius != "" && height1 != "" && height2 != "") {
    document.getElementById("resofobcyvol1").innerHTML =
      "\\[Volume \\space of \\space Wedge \\space is \\]";
    renderMathInElement(document.getElementById("resofobcyvol1"));
    document.getElementById("resofobcyvol2").innerHTML =
      "\\[\\pi \\times" +
      radius +
      "\\times" +
      radius +
    ...
    document.getElementById("resofobcylsa1").innerHTML =
      "\\[Lateral \\space Surface \\space Area \\space (F) \\space of \\space Wedge \\space is \\]";
    renderMathInElement(document.getElementById("resofobcylsa1"));
    document.getElementById("resofobcylsa2").innerHTML =
      "\\[\\pi \\times" +
      radius +
      "(" +
      height1 +
    ...
    document.getElementById("resofobcysa1").innerHTML =
      "\\[Surface \\space  Area \\space of \\space Wedge \\space is \\]";
    renderMathInElement(document.getElementById("resofobcysa1"));
    document.getElementById("resofobcysa2").innerHTML =
      "\\[F \\space + \\pi \\times" +
      radius +
      "(" +
      radius +
...
function solvecube() {
  ...
  if (side != "") {
    voltemp += "\\[" + side + "^3 \\]";
    voltemp +=
      "\\[Volume \\space of \\space cube \\space is \\space " +
      eval(String(side * side * side)) +
      "\\]";
    voloutput.innerHTML = voltemp;
    tsatemp += "\\[ 6 \\times " + side + "^2 \\]";
    tsatemp +=
      "\\[Total \\space Surface \\space Area \\space of \\space Cube \\space is \\space \\]";
...
function cubosolve() {
  ...
  if (length != "" && breadth != "" && height != "") {
    ...
    voltemp +=
      "\\[Volume \\space of \\space cuboid \\space is \\space " +
      eval(String(length * breadth * height)) +
      "\\]";
    voloutput.innerHTML = voltemp;
    tsatemp +=
      "\\[ 2(" +
      ...
      ") \\]";
    tsatemp +=
      "\\[Total \\space Surface \\space Area \\space of \\space Cuboid \\space is \\space \\]";
    tsatemp +=
      "\\[" +
      eval(
        String(2 * (length * breadth + breadth * height + height * length))
      ) +
      "\\]";
    tsaoutput.innerHTML = tsatemp;
    var breadth2 = breadth * breadth;
    ...
    diagtemp +=
      "\\[d= \\sqrt{" + length + "^2+" + breadth + "^2+" + height + "^2} \\]";
    diagtemp +=
      "\\[ \\sqrt{" + length2 + "+" + breadth + "+" + height2 + "} \\]";
    diagtemp += "\\[ \\sqrt{" + add + "} \\]";
    diagtemp += "\\[" + eval(d).toFixed(3) + "\\]";
    diagoutput.innerHTML = diagtemp;
    renderMathInElement(voloutput);
    renderMathInElement(tsaoutput);
    renderMathInElement(diagoutput);
...
function ellipsoidsolve() {
  ...
  var tsatemp = "";
  var res =
    (a ** 1.6 * b ** 1.6 + b ** 1.6 * c ** 1.6 + a ** 1.6 * c ** 1.6) ** 0.625;
  if (a != "" && b != "" && c != "") {
    voltemp +=
      "\\[" +
      "\\frac{4}{3}" +
      ...
      "\\]";
    voltemp +=
      "\\[Volume \\space of \\space Ellipsoid \\space is \\space " +
      eval(String(4.18 * a * b * c)) +
      "\\]";
    voloutput.innerHTML = voltemp;
    tsatemp +=
      "\\[" +
      ...
      "\\]";
    tsatemp +=
      "\\[Surface \\space area \\space of \\space Ellipsoid \\space is \\space  \\]";
...
function sqprismsolve() {
  ...
  if (height != "" && edge != "") {
    voloutput.innerHTML =
      "\\[Volume \\space of \\space Prism \\space \\space" +
      edge +
      "^2 \\times" +
      height +
      " = " +
    ...
    areaoutput1.innerHTML =
      "\\[Area \\space of \\space Square  \\space Prism \\space is \\]";
    ...
    diaoutput1.innerHTML =
      "\\[Diagonal \\space of \\space Square  \\space Prism \\space is \\]";
    diaoutput2.innerHTML =
      "\\[\\sqrt{2 \\times " +
      edge +
      "^2 + " +
      height +
...
function pentprismsolve() {
  ...
  if (height != "" && edge != "") {
    voltemp +=
      ...
      "\\]";
    voltemp +=
      "\\[Volume \\space of \\space Pentagonal \\space Prism \\space is \\space " +
      eval(String(1.72 * edge * edge * height)) +
      "\\]";
    voloutput.innerHTML = voltemp;
    tsatemp +=
      "\\[" +
      ...
      "\\]";
    tsatemp +=
      "\\[Surface \\space area \\space of \\space Pentagonal \\space Prism \\space is \\space  \\]";
    tsatemp +=
      "\\[" + eval(String(5 * edge * height + 3.44 * edge * edge)) + "\\]";
    tsaoutput.innerHTML = tsatemp;
    renderMathInElement(voloutput);
    renderMathInElement(tsaoutput);
  } else {
...
function hexprismsolve() {
  ...
  if (height != "" && edge != "") {
    voloutput1.innerHTML =
      "\\[Volume \\space of \\space Hexagonal  \\space Prism \\space is \\]";
    ...
    areaoutput1.innerHTML =
      "\\[Area \\space of \\space Hexagonal  \\space Prism \\space is \\]";
    areaoutput2.innerHTML =
      "\\[6 \\times " +
      edge +
      "\\times" +
...
function octprismsolve() {
  ...
  if (height != "" && edge != "") {
    voloutput1.innerHTML =
      "\\[Volume \\space of \\space Octagonal  \\space Prism \\space is \\]";
    voloutput2.innerHTML =
      "\\[2 \\times ( 1 \\space + \\space \\sqrt" +
      2 +
      ") \\times" +
      edge +
      "\\times" +
    ...
    renderMathInElement(voloutput2);
    areaoutput1.innerHTML =
      "\\[Area \\space of \\space Octagonal  \\space Prism \\space is \\]";
    areaoutput2.innerHTML =
      "\\[8 \\times " +
      edge +
      "\\times" +
      height +
      " + \\space 4( 1 \\space + \\space \\sqrt" +
      2 +
      ")" +
      edge +
      "\\times" +
...
function traprismsolve() {
  ...
  if (top != "" && base != "" && height != "" && length != "") {
    areatemp +=
      "\\[Area \\space of \\space Trapezium \\space Base \\space is \\space" +
      "\\]";
    areatemp +=
      "\\[\\frac{1}{2}" +
      "\\times" +
      ...
      height +
      "=" +
      eval(String(0.5 * height * top + 0.5 * height * base)) +
      "\\]";
    areaoutput.innerHTML = areatemp;

    voltemp +=
      "\\[Volume \\space of \\space Trapezoidal \\space Prism \\space is \\space \\]";
    voltemp +=
      "\\[\\frac{1}{2}" +
      "\\times" +
      "(" +
      ...
      length +
      "=" +
      eval(String(0.5 * height * top * length + 0.5 * height * base * length)) +
      "\\]";
    voloutput.innerHTML = voltemp;
...
function frustumsolve() {
  ...
  if (radius1 != "" && radius2 != "" && height != "") {
    slanttemp +=
      ...
      "\\]";
    slanttemp +=
      "\\[Slant \\space Height \\space of \\space Conical \\space Frustum \\space is \\space \\]";
    slanttemp +=
      "\\[" +
      eval(
        String(
          Math.sqrt((radius1 - radius2) * (radius1 - radius2) + height * height)
        )
      ) +
      "\\]";
    ...
    lsatemp +=
      ...
      "\\]";
    lsatemp +=
      "\\[Lateral \\space area \\space of \\space Conical \\space Frustum \\space is \\space \\]";
    lsatemp +=
      "\\[" +
      eval(
        String(
          3.14 * radius1 +
            3.14 *
              radius2 *
              Math.sqrt(
                (radius1 - radius2) * (radius1 - radius2) + height * height
              )
        )
      ) +
      "\\]";
    ...
    voltemp +=
      ...
      "\\]";
    voltemp +=
      "\\[Volume \\space area \\space of \\space Conical \\space Frustum \\space is \\space \\]";
    voltemp +=
      "\\[" +
      eval(
        String(
          0.33 * 3.14 * height * radius1 * radius1 +
            0.33 * 3.14 * height * radius2 * radius2 +
            0.33 * 3.14 * height * radius1 * radius2
        )
      ) +
      "\\]";
    voloutput.innerHTML = voltemp;
    tsatemp +=
      ...
      "\\]";
    tsatemp +=
      "\\[Total \\space surface \\space area \\space of \\space Conical \\space Frustum \\space is \\space \\]";
    tsatemp +=
      "\\[" +
      eval(
        String(
          3.14 * radius1 * radius1 +
            3.14 * radius2 * radius2 +
            3.14 * radius1 +
            3.14 *
              radius2 *
              Math.sqrt(
...
findFactors = function () {
  ...
  for (var i = 1; i <= loopCount; i++) {
    if (integer % i == 0)
      // If remainder is 0, then the number is a factor.
...
function pyramidsolve() {
  ...
  if (side != "" && height != "") {
    voltemp +=
      ...
      "\\]";
    voltemp +=
      "\\[Volume \\space of \\space Square \\space Pyramid \\space is \\space \\]";
    ...
    lsatemp +=
      ...
      "\\]";
    lsatemp +=
      "\\[Lateral \\space area \\space of \\space Square \\space Pyramid \\space is \\space \\]";
    lsatemp +=
      "\\[" +
      eval(String(side * Math.sqrt(4 * height * height + side * side))) +
      "\\]";
    lsaoutput.innerHTML = lsatemp;
    ...
    tsatemp +=
      ...
      "\\]";
    tsatemp +=
      "\\[Total \\space Surface \\space area \\space of \\space Pyramid \\space is \\space \\]";
    tsatemp +=
      "\\[" +
      eval(
        String(
          side * Math.sqrt(4 * height * height + side * side) + side * side
        )
      ) +
      "\\]";
    tsaoutput.innerHTML = tsatemp;
    ...
    hsftemp +=
      ...
      "\\]";
    hsftemp +=
      "\\[Height \\space of \\space  side \\space face \\space is \\space \\]";
    hsftemp +=
      "\\[" +
      eval(String(Math.sqrt(height * height + (side / 2) * (side / 2)))) +
      "\\]";
...
function recpyramidsolve() {
  ...
  var tsa =
    l * w +
    l * math.sqrt((w * 0.5) ** 2 + h ** 2) +
    w * math.sqrt((l * 0.5) ** 2 + h ** 2);
  var volume = (l * w * h) / 3;
  var ba = l * w;
  var lsa =
    l * math.sqrt((w * 0.5) ** 2 + h ** 2) +
  ...
  if (l != "" && w != "" && h != "") {
    ...
    lsatemp +=
      ...
      "^2 }\\]";
    lsatemp +=
      "\\[Lateral \\space \\space Surface \\space area  \\space is \\space = " +
      lsa.toFixed(3) +
      " \\]";
    lsaoutput.innerHTML = lsatemp;
    ...
    tsatemp +=
      ...
      "^2 }\\]";
    tsatemp +=
      "\\[Surface \\space area \\space is \\space = " + tsa.toFixed(3) + " \\]";
    tsaoutput.innerHTML = tsatemp;
  } else if (l != "" && w != "") {
    batemp += "\\[" + l + " \\times " + w + "\\]";
    batemp +=
      "\\[Base \\space Area \\space is \\space = " + ba.toFixed(3) + "\\]";
    baoutput.innerHTML = batemp;
  } else {
    tsaoutput.innerHTML = "";
    volumeoutput.innerHTML = "";
...
function tripyramidsolve() {
  ...
  if (side != "" && slant != "" && height != "") {
    voltemp +=
      ...
      "\\]";
    voltemp +=
      "\\[Volume \\space of \\space Triangular \\space Pyramid \\space is \\space \\]";
    ...
    tsatemp +=
      "\\[" +
      eval(String(0.433 * side * side + (3 * side * slant) / 2)) +
      "\\]";
    tsaoutput.innerHTML = tsatemp;
    ...
    basetemp +=
      ...
      "\\]";
    basetemp +=
      "\\[Base \\space Area \\space is \\space" +
      eval(String(0.433 * side * side)) +
      "\\]";
    baseoutput.innerHTML = basetemp;

    peritemp += "\\[" + 3 + "\\times" + side + "\\]";
    peritemp +=
      "\\[Perimeter \\space of \\space Triangular \\space base \\space is \\space" +
      eval(String(3 * side)) +
      "\\]";
    perioutput.innerHTML = peritemp;
...
function octpyramidsolve() {
  ...
  if (side != "" && height != "") {
    ...
    basetemp +=
      ...
      side +
      "\\times" +
      " \\space cot(22.5 \\degree) \\space" +
      "=" +
      eval(String(4.83 * side * side)).toFixed(2) +
      "\\]";
    baseoutput.innerHTML = basetemp;

    voltemp +=
      "\\[Volume \\space of \\space Octagonal \\space Pyramid \\space is \\space \\]";
    voltemp +=
      "\\[\\frac{2}{3} \\space " +
      "\\times" +
      height +
      ...
      " \\space cot(22.5 \\degree) \\space" +
      "=" +
      eval(String(1.61 * height * side * side)).toFixed(2) +
      "\\]";
    voloutput.innerHTML = voltemp;
    ...
    lsatemp +=
      ...
      side +
      "\\times" +
      " \\space cot^2(22.5 \\degree) \\space" +
      ") = " +
      eval(
        String(2 * side * math.sqrt(4 * height * height + 5.83 * side * side))
      ).toFixed(2) +
      "\\]";
    lsaoutput.innerHTML = lsatemp;
    ...
    tsatemp +=
      ...
      eval(
        String(
          2 * side * math.sqrt(4 * height * height + 5.83 * side * side) +
            2.41 * side
        )
      ).toFixed(2) +
      "\\]";
...
function pentpyramidsolve() {
  ...
  var area =
    (5 / 4) * 1.3763819 * side * side +
    5 * (side / 2) * math.sqrt(height * height + ((side * 1.3763819) / 2) ** 2);
  console.log("vol");
  console.log(vol);
  console.log("area");
  console.log(area);
  if (height != "" && side != "") {
    voloutput1.innerHTML =
      "\\[Volume \\space of \\space Pentagonal  \\space Pyramid \\space is \\]";
    voloutput2.innerHTML =
      "\\[\\frac{5}{12} \\space tan(54 \\degree) \\space " +
      height +
      "\\times " +
      side +
      " \\times " +
    ...
    renderMathInElement(voloutput2);
    areaoutput1.innerHTML =
      "\\[Area \\space of \\space Pentagonal  \\space Pyramid \\space is \\]";
    areaoutput2.innerHTML =
      "\\[\\frac{5}{4} \\space tan(54 \\degree) \\space " +
      side +
      "\\times " +
      side +
      " \\space + \\frac{5\\times " +
...
function hexpyramidsolve() {
  ...
  if (base != "" && apothem != "" && slant != "" && height != "") {
    ...
    basetemp +=
      ...
      base +
      "=" +
      eval(String(3 * apothem * base)) +
      "\\]";
    baseoutput.innerHTML = basetemp;

    voltemp +=
      "\\[Volume \\space of \\space Hexagonal \\space Pyramid \\space is \\space \\]";
    voltemp +=
      "\\[" +
      apothem +
      "\\times" +
      ...
      height +
      "=" +
      eval(String(apothem * base * height)) +
      "\\]";
    voloutput.innerHTML = voltemp;
    ...
    tsatemp +=
      ...
      ")" +
      "=" +
      eval(String(3 * apothem * base + 3 * base * slant)) +
      "\\]";
    tsaoutput.innerHTML = tsatemp;

    peritemp +=
      "\\[Perimeter \\space of \\space Hexagonal \\space base \\space is \\space" +
      "\\]";
    peritemp +=
      "\\[" + 6 + "\\times" + base + "=" + eval(String(6 * base)) + "\\]";
    perioutput.innerHTML = peritemp;
...
function wedgesolve() {
  ...
  if (side != "" && width != "" && topside != "" && height != "") {
    ...
    document.getElementById("resofwedgelsa1").innerHTML =
      "\\[Lateral \\space Surface \\space Area \\space (F) \\space of \\space Wedge \\space is \\]";
    renderMathInElement(document.getElementById("resofwedgelsa1"));
    document.getElementById("resofwedgelsa2").innerHTML =
      "\\[ \\frac{" +
      side +
      "\\times" +
      topside +
    ...
    document.getElementById("resofwedgesa1").innerHTML =
      "\\[Surface \\space  Area \\space of \\space Wedge \\space is \\]";
    renderMathInElement(document.getElementById("resofwedgesa1"));
    document.getElementById("resofwedgesa2").innerHTML =
      "\\[F \\space + " +
      side +
      "\\times" +
      width +
...
function solvesphere() {
  ...
  if (radius != "") {
    ...
    voltemp +=
      "\\[Volume \\space of \\space Sphere \\space is \\space " +
      a.toFixed(3) +
      "\\space cm^3\\]";
    voloutput.innerHTML = voltemp;
    ...
    diatemp +=
      "\\[Diameter \\space of \\space a \\space Sphere \\space is \\space \\]";
...
function solvehollowsphere() {
  ...
  if (radius1 != "" && radius2 != "") {
    if (radius1 <= radius2) {
      ...
      voltemp +=
        "\\[ \\frac{4}{3} \\times \\pi \\times (" +
        radius1 +
        "^3-" +
        radius2 +
        "^3) \\]";
      voltemp +=
        "\\[Volume \\space of \\space Hollow \\space Sphere \\space is \\space " +
        eval(
          String(
            (4 *
              3.14159 *
      ...
      voloutput.innerHTML = voltemp;
      tsatemp +=
        "\\[4 \\times \\pi \\times" + radius1 + "^2 -" + radius2 + "^2 \\]";
      tsatemp +=
        "\\[Total \\space Surface \\space Area \\space of \\space Hollow \\space Sphere \\space is \\space  \\]";
      tsatemp +=
        "\\[" +
        eval(String(4 * 3.14159 * (radius1 * radius1 - radius2 * radius2))) +
        "\\]";
    }
    tsaoutput.innerHTML = tsatemp;
    renderMathInElement(voloutput);
...
function solvehemisphere() {
  ...
  if (radius != "") {
    ...
    voltemp +=
      "\\[Volume \\space of \\space HemiSphere \\space is \\space " +
      eval(String((2 * 3.14159 * radius * radius * radius) / 3)) +
      "\\]";
    voloutput.innerHTML = voltemp;
...
function solveCone() {
  ...
  if (radius != "" && height != "") {
    voltemp +=
      "\\[ \\frac{1}{3} \\times \\pi \\times " +
      radius +
      "^2 \\times " +
      height +
      "\\]";
    voltemp +=
      "\\[Volume \\space of \\space Cone \\space is \\space " +
      eval(String(vol)) +
      "\\]";
    voloutput.innerHTML = voltemp;
    csatemp += "\\[ \\pi \\times" + radius + "\\times" + l.toFixed(3) + " \\]";
    csatemp +=
      "\\[Curved \\space Surface \\space Area \\space of \\space Cone \\space is \\space \\]";
    csatemp +=
      "\\[" + eval(String(3.14159 * radius * eval(l).toFixed(3))) + "\\]";
    csaoutput.innerHTML = csatemp;
    ...
    tsatemp +=
      ...
      eval(
        String(
          3.14159 * radius * eval(l).toFixed(3) + 3.14159 * radius * radius
        )
      ) +
      "\\]";
    tsaoutput.innerHTML = tsatemp;
...
function torussolve() {
  ...
  if (radius1 != "" && radius2 != "") {
    voltemp +=
      ...
      " ) \\]";
    voltemp +=
      "\\[Volume \\space of \\space Torus  \\space is \\space " +
      vol.toFixed(3) +
      "\\]";
    voloutput.innerHTML = voltemp;
    tsatemp +=
...
function solvendimsphere() {
  ...
  var ansVol =
    (Math.pow(Math.PI, dim / 2) * Math.pow(radius, dim)) / gamma(dim / 2 + 1);
  var ansArea =
    (2 * Math.pow(Math.PI, dim / 2) * Math.pow(radius, dim - 1)) /
    gamma(dim / 2);
  console.log("vol");
  console.log(ansVol);
  console.log("area");
  console.log(ansArea);
  if (dim != "" && radius != "") {
    volOutputTitle.innerHTML =
      "\\[Volume \\space of \\space Sphere \\space in \\space n \\space dimension \\space is \\]";
    volOutputMain.innerHTML =
      "\\[\\frac{\\pi ^{\\frac{" +
      dim +
      "}{2}}" +
      radius +
    ...
    areaOutputTitle.innerHTML =
      "\\[Surface \\space Area \\space of \\space Sphere \\space in \\space n \\space dimension \\space is \\]";
    areaOutputMain.innerHTML =
      "\\[\\frac{2\\pi ^{\\frac{" +
      dim +
      "}{2}}" +
      radius +
...
function orderas() {
  ...
  if (val == null) {
    document.getElementById(
      "orderresult"
    ).innerHTML = `Proper input is required`;
    return;
  }
...
function masscon() {
  ...
  if (i >= 0) {
    ...
    document.getElementById("massconou").innerHTML =
      "Mass cannot be negative. Kindly enter a positive value.";
  }
}
...
function polarcx() {
  ...
  let explain =
    "\\[Polar \\space Form \\space =r(cos(\\theta)+i\\space sin(\\theta))\\]";
  explain +=
...
function expoxn() {
  ...
  var y = nerdamer(Math.atan(i / r) / 3.141592653589793)
    .evaluate()
    .toString();
  var x = "iπ *" + y;
...
function datacon() {
  ...
  if (i >= 0) {
    ...
    document.getElementById("dataconou").innerHTML =
      "Data size cannot be negative. Kindly enter a positive value.";
  }
}
...
function simple_interest() {
  ...
  sitemp2.innerHTML = "";
  if (p == "" || t == "" || r == "") {
    document.getElementById("simpleinterstoutput1").innerHTML =
    ...
    if (si < 0) {
      ...
      document.getElementById("simpleinterstoutput1").innerHTML =
        "\\[Simple \\space Interest = \\space \\frac{1}{100} \\times p \\times t \\times r \\]";
      document.getElementById("simpleinterstoutput2").innerHTML =
        "\\[\\frac{1}{100} \\times " +
        p +
        "\\times " +
        t +
        ...
        " = ₹" +
        si.toFixed(5) +
        "\\]<br>\\[Amount \\space = \\space " +
        p +
        "\\space + \\space " +
        si.toFixed(5) +
        "\\space = \\space " +
        (parseFloat(p) + parseFloat(si.toFixed(5))) +
        "\\]";
      ...
      ci = amount - p;
      document.getElementById("compoundinterestoutput1").innerHTML =
        "\\[Compound \\space Interest =P\\left(1+\\frac{r}{n}\\right)^{n t}\\]";
      document.getElementById("compoundinterestoutput2").innerHTML =
        "\\[" +
        p +
        "\\left(1+\\frac{" +
        r +
        ...
        ci.toFixed(5) +
        "\\space = \\space " +
        (parseFloat(p) + parseFloat(ci.toFixed(5))) +
        "\\]";
...
function emical() {
  ...
  document.getElementById("emio1").innerHTML =
    "\\[\\mathrm{EMI}=\\frac{\\mathrm{P} \\times \\mathrm{r} \\times(1+\\mathrm{r})^{\\mathrm{t}}}{(1+\\mathrm{r})^{t}-1}\\]";
  document.getElementById("emio4").innerHTML =
    "\\[(\\mathrm{" +
    t1 +
    "} \\space \\mathrm{Year} = \\mathrm{" +
    t.toFixed(3) +
    "} \\space \\mathrm{Months} = \\mathrm{t})\\]";
  document.getElementById("emio2").innerHTML =
    "\\[\\mathrm{EMI}=\\frac{\\mathrm{" +
    p +
    "} \\times \\mathrm{" +
    r.toFixed(2) +
    "} \\times(1+\\mathrm{" +
...
function gstcal() {
  ...
  if (isNaN(p) || isNaN(r)) {
    ...
    document.getElementById("gst1").innerHTML =
    ...
    var gst_work = "",
      gst_result = "";
    gst_work +=
      "\\[\\mathrm{GST}=\\frac{\\mathrm{Original}\\space\\mathrm{Cost}\\times\\mathrm{GST}\\%}{100}\\]" +
      "\\[\\mathrm{GST}=\\space" +
      p +
      "\\times" +
      r +
      ...
      "\\]";
    gst_work +=
      "\\[\\mathrm{CGST/SGST}=\\frac{\\mathrm{GST}}{2}\\]" +
      "\\[\\mathrm{CGST/SGST}= \\space" +
      cgst.toFixed(2) +
      "\\]";
    gst_work +=
      "\\[\\mathrm{Final}\\space\\mathrm{Cost}=\\space\\mathrm{Original}\\space\\mathrm{Cost}+\\mathrm{GST}\\]" +
      "\\[\\mathrm{Final}\\space\\mathrm{Cost}=\\space" +
      p +
      "+\\space" +
      gst.toFixed(2) +
      "\\]";
  ...
  fetch("https://api.exchangerate-api.com/v4/latest/USD")
    ...
    .then(
      (curout = function (c) {
        ...
        if (i < 0) {
          document.getElementById("curconou").innerHTML =
            "Enter <strong>only</strong> positive amount values";
        } else {
...
function leap() {
  ...
  if (ans) out.innerHTML = `${i} is a Leap Year`;
  else out.innerHTML = `${i} is not a Leap Year`;
}
...
function timecon() {
  ...
  if (i >= 0) {
    ...
    document.getElementById("timeconou").innerHTML =
      "Time cannot be negative. Kindly enter a positive value.";
  }
}
...
function factorialsol(factorialval) {
  ...
  if (isNaN(num1)) {
    ...
    desc.innerHTML =
      "Factorial is not defined for negative integer since, gamma function is not defined for negative integer";
    ans.innerHTML = "";
...
function profitloss() {
  ...
  if (cp < 0 || sp < 0) {
    document.getElementById("pol1").innerHTML =
      "<strong>Only</strong> positive values are accepted";
  } else if (cp > sp) {
    var loss = cp - sp;
    var perl = (loss * 100) / cp;
    document.getElementById("pol1").innerHTML =
      "\\[Loss = Cost\\space Price - Selling\\space Price\\]";
    document.getElementById("pol2").innerHTML =
      "\\[Loss = " + cp + " - " + sp + " \\space =  " + loss + "\\]";
    renderMathInElement(document.getElementById("pol1"));
    renderMathInElement(document.getElementById("pol2"));
    document.getElementById("percent1").innerHTML =
      "\\[Loss\\space Percentage = \\frac{loss}{cost\\space price} \\times 100 \\%\\]";
    document.getElementById("percent2").innerHTML =
      "\\[Loss\\space Percentage =\\frac{" +
      loss +
      "}{" +
      cp +
      "} \\times 100 = " +
    ...
    document.getElementById("pol1").innerHTML =
      "\\[Profit = Selling\\space Price - Cost\\space Price\\]";
    document.getElementById("pol2").innerHTML =
      "\\[Profit = " + sp + " - " + cp + " \\space =  " + profit + "\\]";
    renderMathInElement(document.getElementById("pol1"));
    renderMathInElement(document.getElementById("pol2"));
    document.getElementById("percent1").innerHTML =
      "\\[Profit\\space Percentage = \\frac{Profit}{Selling\\space price} \\times 100 \\%\\]";
    document.getElementById("percent2").innerHTML =
      "\\[Profit\\space Percentage =\\frac{" +
      profit +
      "}{" +
      sp +
      "} \\times 100 = " +
...
function discount() {
  ...
  if (dis < 0 || cpsp < 0 || dis == NaN || cpsp == NaN) {
    document.getElementById("discountresult").innerHTML =
      "<strong>Only</strong> positive values are accepted. Refrain from blank inputs and negative values.";
  } else {
    var cp = 0;
    var sp = 0;
    var discount = "";
    ...
    if (cp < 0 || sp < 0) {
      print =
        "The the entered data is resulting in a negative Cost/Selling Price.";
    } else if (cp > sp) {
      var loss = cp - sp;
      var perl = (loss * 100) / cp;
      print =
...
function exposol() {
  ...
  if (x != "" && y != "") {
    ntemp +=
      "\\[Value \\space of \\space n \\space is \\space : \\space" +
      eval(String(Math.log(y) / Math.log(x))) +
      "\\]";
    n.innerHTML = ntemp;
    ...
    explain +=
      ...
      "\\]";
    explain +=
      "\\[ Take \\space log \\space of \\space both \\space the \\space sides \\space : \\space log" +
      x +
      "^{n} \\space = \\space log" +
      y +
      "\\] ";
    explain +=
      "\\[ By \\space identity \\space we \\space get \\space : \\space nlog" +
      x +
      "= \\space log" +
      y +
      "\\]";
    explain +=
      "\\[Dividing \\space both \\space sides \\space by \\space log" +
      x +
      "\\space :" +
      "n \\space = \\frac{log" +
      y +
...
function cal_func_stats() {
  ...
  if (num == "") {
    ...
    document.getElementById("result_cal_func_stats").innerHTML =
      "Enter space separated numbers.<br>Example -> 1  2  2.1  -2  -2.6 <br> Use of alphabets and special character is not allowed for calculation purpose";
  } else {
    var print = "";
    var s = 0;
    num = num.trim();
...
function sum_n_apsol(nval, rval, r1val) {
  ...
  if (!isNaN(parseInt(n)) || !isNaN(parseInt(a)) || !isNaN(parseInt(d))) {
    ...
    printseries.innerHTML =
      "Arithmetic Progression: " + series.substring(0, series.length - 2);
...
function anotherap() {
  ...
  if (isNaN(parseInt(n)) || isNaN(parseInt(a)) || isNaN(parseInt(l))) {
    document.getElementById("printAPseries1").innerHTML =
      "Enter numbers only. Blank inputs are not allowed";
...
function apsum() {
  ...
  if (parseInt(val.length) < 2)
    document.getElementById("printAP").innerHTML =
      "Enter atleast 2 terms of AP";
  else {
    if (parseInt(val.length) > 2 && val[1] - val[0] != val[2] - val[1]) {
      ...
      var d = val[1] - val[0];
      document.getElementById("printAP").innerHTML =
        "Common difference for the entered AP is &nbsp;" + d + "<br>";
      for (i = 0; i < n; i++) {
        document.getElementById("printAP").innerHTML +=
          eval(String(i + "*" + d + "+" + val[0])) + ",";
...
function amsol() {
  ...
  explain.innerHTML =
    "Formula: \\[Arithmetic \\space Mean=\\space \\frac{a+c}{2} =\\space \\frac{" +
    a +
    "+" +
    c +
    "}{2}\\] ";
...
function gmsol() {
  ...
  if (a < 0 && c < 0) {
    ...
    explain.innerHTML =
      "Formula: \\[\\space Geometric \\space Mean=\\space\\ - \\sqrt{a \\times c} = \\space\\ - \\sqrt{" +
      a +
      "\\times" +
      c +
      "}\\] ";
    ...
    var explain = document.getElementById("gm_formula");
    explain.innerHTML =
      "Please enter either both positive or both negative values to calculate the Geomteric Mean";
...
function hmsol() {
  ...
  explain.innerHTML =
    "Formula: \\[Harmonic \\space Mean=\\space \\frac{2ac}{a+c} = \\space \\frac{2\\times" +
    a +
    "\\times" +
    c +
    "}{" +
...
function check_prime(isprime) {
  ...
  if (!isNaN(num1)) {
    if (num1 >= 0) {
      ...
      ans.innerHTML =
        "There are no negative prime numbers. Enter positive numbers to check for Primality.";
    }
  } else ans.innerHTML = "Enter an integer!";
}
...
function prime_till_num(primetill) {
  ...
  b = parseInt(b);
  if (isNaN(b) || b <= 1) {
    document.getElementById("primetillsol").innerHTML =
      "Enter positive integer greater than 1.";
  } else {
    var w = "";
    for (var f = 1; f <= b; f++) {
    ...
    document.getElementById("primetillsol").innerHTML = w.slice(
      0,
      w.length - 2
    );
  }
...
function gp() {
  ...
  if (!isNaN(parseInt(n)) || !isNaN(parseInt(a)) || !isNaN(parseInt(r))) {
    ...
    printseries.innerHTML =
      "Geometric Progression: " + series.substring(0, series.length - 2);
  } else {
    printseries.innerHTML = "Enter numbers only. Blank inputs are not allowed";
    explain.innerHTML = "";
    return;
...
function igp() {
  ...
  if (isNaN(parseInt(a)) || isNaN(parseInt(r))) {
    document.getElementById("sumigp").innerHTML =
      "Enter numbers only. Blank inputs are not allowed";
    return;
  }
  if (r >= 1) {
    document.getElementById("sumigp").innerHTML =
      "Please enter a common ratio which is less than 1";
  } else {
    var ans = a / (1 - r);
...
function hypf() {
  ...
  document.getElementById("hypans1").innerHTML =
    "\\[The \\space volume \\space of \\space Hyperboloid \\space is \\space \\]";
  renderMathInElement(document.getElementById("hypans1"));

  document.getElementById("hypans2").innerHTML =
    "\\[\\frac{2 \\times \\pi \\times" +
    hyph +
    "\\times" +
    hypa +
  ...
  document.getElementById("hypans3").innerHTML =
    "\\[ = " + ans.toFixed(3) + "\\]";
...
function Variance() {
  ...
  if (val.length === 0) {
    ...
    for (i = 0; i < len; i++) {
      ...
      if (i == 0) {
        document.getElementById("Meanresult").innerHTML += `(${String(
          Math.pow(num - mean, 2)
        )}`;
      } else {
        document.getElementById("Meanresult").innerHTML += ` + ${String(
    ...
    document.getElementById(
      "Meanresult"
    ).innerHTML += `)/${val.length} &nbsp; =  &nbsp;`;
    document.getElementById("Meanresult").innerHTML += ans.toFixed(5);
    document.getElementById(
      "Meanresult"
    ).innerHTML += `/${val.length} &nbsp;= <br>`;
    ans = ans / len;
    document.getElementById("Meanresult").innerHTML += ans.toFixed(5);
  }
...
function std() {
  ...
  if (val.length === 0) {
    ...
    document.getElementById(
      "Meanresult"
    ).innerHTML = `Standard Deviation is => <br>`;
    var mean = s / len;
    for (i = 0; i < len; i++) {
      num = parseFloat(val[i]);
      ans = ans + Math.pow(num - mean, 2);
...
function fracDectoBinHexOct(value, base) {
  ...
  while (i <= 7) {
    ...
    fraction =
      "0" + fraction.toString().substring(fraction.toString().indexOf("."));
    n = Math.abs(fraction);
    if (n - Math.floor(n) == 0) {
      break;
    }
...
function bitwiseCalc() {
  addEventListener("change", (x) => {
    if (operation == "NOT")
      ...
      document.getElementById("bitwise-second-number").style =
  ...
  let result;
  let firstOperand = document.getElementById("bitwise-first-number").value;
  let secondOperand = document.getElementById("bitwise-second-number").value;
  var x = 0;
...
function subBinDecHexOct() {
  ...
  if (base === "Binary") {
    ...
    print +=
      "<h5>STEP 0 : Find 2's complement of Subtrahend</h5>" +
      input2 +
      "->" +
      twoco;
    add = (parseInt(twoco, 2) + parseInt(input1, 2)).toString(2);
    print +=
      "<br><br><h5>STEP 1 : Add Minuend and 2's complement of Subtrahend</h5>" +
      "<p>&nbsp;&nbsp;&nbsp;" +
      input1 +
      "<br>+&nbsp;" +
      twoco +
    ...
    if (add.length == input1.length) {
      ...
      print +=
        "<br><h5>STEP 3 : Find 2's complement of sum found in 'STEP 1'</h5>";
      print +=
        "ANSWER (Two's complement of the sum ) ->  <span style='text-decoration: underline;'>-" +
        ans +
        "</span>";
      ...
      print +=
        "<br><h5>STEP 3 : Find 2's complement of sum found in 'STEP 1'</h5>";
      print +=
        "ANSWER (Discard the carry) ->   <span style='text-decoration: underline;'>" +
        ans +
        "</span>";
    } else if (add.length < input1.length) {
    ...
    print +=
      "<h5>STEP 0 : Find 8's complement of Subtrahend</h5>" +
      input2 +
      "->" +
      eigco;
    add1 = (parseInt(eigco, 8) + parseInt(input1, 8)).toString(8);
    print +=
      "<br><br><h5>STEP 1 : Add Minuend and 8's complement of Subtrahend</h5>" +
      "<p>&nbsp;&nbsp;&nbsp;" +
      input1 +
      "<br>+&nbsp;" +
      eigco +
    ...
    if (add1.length == input1.length) {
      ...
      print += "Note- No carry is present. So, answer will be -ve <br>";
      print +=
        "<br><h5>STEP 3 : Find 8's complement of sum found in 'STEP 1'</h5>";
      print +=
        "ANSWER (Eight's complement of the sum ) ->  <span style='text-decoration: underline;'>-" +
        ans1 +
        "</span>";
...
function multBinDecHexOct() {
  ...
  const resultType = document.getElementById("multiplying-all-result-type")
    .value;
  let result = document.getElementById("multiplying-all-result");
  var x1;
  var x2;

  if (firstBase === "Binary") x1 = parseInt(input1, 2);
  else if (firstBase === "Octal") x1 = parseInt(input1, 8);
  else if (firstBase === "Hexa Decimal") x1 = parseInt(input1, 16);
  else if (firstBase === "Decimal") x1 = parseInt(input1);

  if (secondBase === "Binary") x2 = parseInt(input2, 2);
  else if (secondBase === "Octal") x2 = parseInt(input2, 8);
  else if (secondBase === "Hexa Decimal") x2 = parseInt(input2, 16);
  else if (secondBase === "Decimal") x2 = parseInt(input2);
...
function separator(str, n) {
  //used for converting BCD code to decimal
  var val = [];
  var i, l;
...
function bcdTOdecimal(x) {
  ...
  if (y % 4 == 1 || y == 1) input1 = "000" + x;
  else if (y % 4 == 2 || y == 2) input1 = "00" + x;
  else if (y % 4 == 3 || y == 3) input1 = "0" + x;
  else input1 = x;
  const minVal = (currentValue) => currentValue <= 9;
  w = separator(input1, 4);
  if (w.every(minVal) == true) return w;
  else return inv;
}
...
function convertbcd() {
  ...
  if (fromCode == "BCD Code" && toCode == "BCD Code") result.innerHTML = input;
...
function bcdadd() {
  ...
  var decimalresult;
  var bcdresult;
  if (s1 == "INVALID" || s2 == "INVALID") result.innerHTML = "INVALID BCD";
  else {
...
function onetwoCalc() {
  ...
  var print =
    "<h5 style='margin-top: 50px;'>Working of the 1's Complement -</h5> &emsp;";
  var ar = input.split("");
  ...
  print +=
    "<br><h5 style='margin-top: 5px;'>Working of the 2's Complement -</h5> &emsp; 1's Complement + 1 = 2's Complement <br>&emsp; ";
  print +=
    onec +
    " + 1</span> = <span style='text-decoration: underline;'>" +
    twoc +
    "</span>";
  work.innerHTML = print;
...
function seveneightCalc() {
  ...
  var print =
    "<h5 style='margin-top: 50px;'>Working of the 7's Complement -</h5> &emsp;";
  var seven = "";
  var eight = "";
  ...
  result.innerHTML =
    "Seven's complement of " + input + " is " + parseInt(seven) + "<br>";
  result.innerHTML +=
    "Eight's complement of " + input + " is " + eight + "<br>";
  ...
  print +=
    ...
    "</span><br>";
  print +=
    "<br><h5 style='margin-top: 5px;'>Working of the 8's Complement -</h5> &emsp; 7's Complement + 1 = 8's Complement <br>&emsp; ";
  print +=
    seven +
    " + 1</span> = <span style='text-decoration: underline;'>" +
    eight +
  ...
  if (input == "") {
    ...
    result.innerHTML =
      "Octal Numbers can only have digits between 0 to 7 and - sign not allowed";
    work.innerHTML = "";
  }
}
...
function fiftnsixtnCalc() {
  ...
  if (!valid.test(input)) {
    ...
    var print =
      "<h5 style='margin-top: 50px;'>Working of the 15's Complement -</h5> &emsp;";
    var fiftn = "";
    var sixtn = "";
    ...
    result.innerHTML =
      "Fifteen's complement of " + input + " is " + fiftn + "<br>";
    result.innerHTML +=
      "Sixteen's complement of " + input + " is " + sixtn + "<br>";
    ...
    print +=
      ...
      "</span><br>";
    print +=
      "<br><h5 style='margin-top: 5px;'>Working of the 16's Complement -</h5> &emsp; 15's Complement + 1 = 16's Complement <br>&emsp; ";
    print +=
      fiftn +
      " + 1</span> = <span style='text-decoration: underline;'>" +
      sixtn +
...
function ninetenCalc() {
  ...
  var print =
    "<h5 style='margin-top: 50px;'>Working of the 9's Complement -</h5> &emsp;";
  var nine = "";
  var ten = "";
  for (var i = 0; i < input.length; i++) {
    print += "9";
  ...
  ten = parseInt(nine) + 1;
  result.innerHTML =
    "Nine's complement of " + input + " is " + parseInt(nine) + "<br>";
  ...
  print +=
    ...
    "</span><br>";
  print +=
    "<br><h5 style='margin-top: 5px;'>Working of the 10's Complement -</h5> &emsp; 9's Complement + 1 = 10's Complement <br>&emsp; ";
  print +=
    nine +
    " + 1</span> = <span style='text-decoration: underline;'>" +
    ten +
  ...
  if (input == "") {
    ...
    result.innerHTML =
      "Decimal Numbers can only have digits between 0 to 9 and '-' sign not allowed";
}
...
function datecal() {
  ...
  if (d.getTime() > c.getTime()) {
    ...
    if (y >= 0) {
      document.getElementById(
        "date-1"
      ).innerHTML = `${y} Years ${m} Month ${da} Days`;
...
function computeprobability() {
  ...
  if (favour < 0 || nettotal < 0) {
    ...
    result.innerHTML =
      "Number of favourable outcomes can't exceeds number of possible outcomes";
  } else {
    result.innerHTML =
      "The probability of the event is : " + (favour / nettotal).toFixed(3);
  }
}
...
function condprobability() {
  ...
  if (netevent < 0 || event < 0) {
    document.getElementById("result1").innerHTML =
      "Outcomes can't be negative, Enter positive values only. ";
    document.getElementById("result2").innerHTML = "";
    document.getElementById("result3").innerHTML = "";
  } else {
    document.getElementById("result1").innerHTML =
      "  (P(B | A)) = P(A ∩ B) &divide P(A) ";
    document.getElementById("result2").innerHTML =
      " (P(B | A)) =" + netevent + " &divide " + event;
    document.getElementById("result3").innerHTML =
      " Probability of Event B given Event A (P(B | A)) = " + result1;
  }
}
...
function computejointprobability() {
  ...
  if (favourable1 >= 0 && total1 > 0 && favourable2 >= 0 && total2 > 0) {
    if (favourable1 > total1) {
      result1.innerHTML =
        "Number of favourable outcomes can't exceeds number of possible outcomes in first event";
      check = false;
    } else {
      result1.innerHTML =
        "The probability of first event is : " + probability1.toFixed(3);
    }

    if (favourable2 > total2) {
      result2.innerHTML =
        "Number of favourable outcomes can't exceeds number of possible outcomes in second event";
      check = false;
    } else {
      result2.innerHTML =
        "The probability of second event is : " + probability2.toFixed(3);
    }

    if (check == true) {
      result3.innerHTML =
        "The joint probability of both the events is: " +
        probability3.toFixed(3);
    }
  } else {
    result1.innerHTML =
      "Outcomes can't be negative. Enter positive values only";
...
function computebayesprobability() {
  ...
  if (favourable1 >= 0 && total1 > 0 && favourable2 >= 0 && total2 > 0) {
    if (favourable1 > total1) {
      ...
      result1.innerHTML =
        "Probability of intersection is always equal to or less than the probability of individual events";
      result2.innerHTML = "";
      check = false;
    }
    ...
    if (check == true) {
      result1.innerHTML =
        "The likelihood of event  A occurring given that B is true is:- " +
        probability3.toFixed(3);
      result2.innerHTML =
        "The likelihood of event  B occurring given that A is true is:- " +
        probability4.toFixed(3);
    }
  } else {
    result.innerHTML = "Outcomes can't be negative. Enter positive values only";
  }
...
function rankcal() {
  ...
  if (input.match(/^[A-Za-z]+$/)) {
    result.innerHTML = ans;
  } else result.innerHTML = "Invalid input use alphabet only";
}
...
function ssscal() {
  ...
  if (a == "" || b == "" || c == "") {
    ...
    ca = ca.toPrecision(4);
    ans =
      "The required angles oppsite to first side is: " +
      ab +
      " second side is: " +
      bc +
      "  third side is: " +
