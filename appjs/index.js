...
function changeImage0() {
  ...
  if (a0 % 2 == 0) {
    document.getElementById("imgClickAndChange0").src =
      "icons/down-chevron.svg";
  } else {
    document.getElementById("imgClickAndChange0").src =
      "icons/chevron-arrow-up.svg";
  }
}
...
function changeImage1() {
  ...
  if (a % 2 == 0) {
    document.getElementById("imgClickAndChange1").src =
      "icons/down-chevron.svg";
  } else {
    document.getElementById("imgClickAndChange1").src =
      "icons/chevron-arrow-up.svg";
...
function changeImage3() {
  ...
  if (c % 2 == 0) {
    document.getElementById("imgClickAndChange3").src =
      "icons/down-chevron.svg";
  } else {
    document.getElementById("imgClickAndChange3").src =
      "icons/chevron-arrow-up.svg";
...
function changeImage4() {
  ...
  if (d % 2 == 0) {
    document.getElementById("imgClickAndChange4").src =
      "icons/down-chevron.svg";
  } else {
    document.getElementById("imgClickAndChange4").src =
      "icons/chevron-arrow-up.svg";
...
function changeImage5() {
  ...
  if (e % 2 == 0) {
    document.getElementById("imgClickAndChange5").src =
      "icons/down-chevron.svg";
  } else {
    document.getElementById("imgClickAndChange5").src =
      "icons/chevron-arrow-up.svg";
...
function changeImage6() {
  ...
  if (f % 2 == 0) {
    document.getElementById("imgClickAndChange6").src =
      "icons/down-chevron.svg";
  } else {
    document.getElementById("imgClickAndChange6").src =
      "icons/chevron-arrow-up.svg";
...
function changeImage7() {
  ...
  if (g % 2 == 0) {
    document.getElementById("imgClickAndChange7").src =
      "icons/down-chevron.svg";
  } else {
    document.getElementById("imgClickAndChange7").src =
      "icons/chevron-arrow-up.svg";
...
function changeImage8() {
  h++;
  if (h % 2 == 0) {
    document.getElementById("imgClickAndChange8").src =
      "icons/down-chevron.svg";
  } else {
    document.getElementById("imgClickAndChange8").src =
      "icons/chevron-arrow-up.svg";
...
function changeImage9() {
  ...
  if (i % 2 == 0) {
    document.getElementById("imgClickAndChange9").src =
      "icons/down-chevron.svg";
  } else {
    document.getElementById("imgClickAndChange9").src =
      "icons/chevron-arrow-up.svg";
