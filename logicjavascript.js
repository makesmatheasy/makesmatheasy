...
//end of roman
    ...
    function printfactors(){
            ...
            for(i=2;i<=num2;i++){
               ...
               document.getElementById("result1").innerHTML=tt;
               document.getElementById("result12").innerHTML="Prime Factors are <b>[&nbsp;&nbsp;&nbsp;</b>"+v+"<b>]</b><br>";
            }
        }
...
//            }
            if(parseInt(hyp)<parseInt(pp) || parseInt(hyp)<parseInt(base)){
                ...
                if(pp.toString()!='NaN'){
                pp=pp.toFixed(2);
                var tempp="\\[Value\\quad of\\quad  Perpendicular= \\sqrt{"+kl+"}="+pp+"\\]";
                ...
                base=base.toFixed(2);
                var tempp="\\[Value\\quad of\\quad Base= \\sqrt{"+kll+"}="+base+"\\]";
                tempp+=String("\\[sin\\theta =\\frac{p}{h} =\\frac{"+pp+"}{"+hyp+"} = "+eval(String(pp+"/"+hyp)).toFixed(2))+'\\]';
                tempp+="\\[cos\\theta=\\frac{b}{h} =\\frac{"+base+"}{"+hyp+"} = "+ eval(String(base+"/"+hyp)).toFixed(2)+'\\]';
                tempp+="\\[tan\\theta=\\frac{p}{b} =\\frac{"+pp+"}{"+base+"}= "+ eval(String(pp+"/"+base)).toFixed(2)+'\\]';
                tempp+="\\[cosec\\theta=\\frac{h}{p} =\\frac{"+hyp+"}{"+pp+"}= "+ eval(String(hyp+"/"+pp)).toFixed(2)+'\\]';
                ...
                if(hyp.toString()!='NaN'){
                hyp=hyp.toFixed(2);
                var tempp="\\[Value\\quad of\\quad Hypotenuse=\\sqrt{"+klll+"}="+hyp+"\\]";
                tempp+=String("\\[sin\\theta =\\frac{p}{h} =\\frac{"+pp+"}{"+hyp+"}= "+eval(String(pp+"/"+hyp)).toFixed(2))+'\\]';
                tempp+="\\[cos\\theta=\\frac{b}{h} =\\frac{"+base+"}{"+hyp+"}= "+ eval(String(base+"/"+hyp)).toFixed(2)+'\\]';
                tempp+="\\[tan\\theta=\\frac{p}{b} =\\frac{"+pp+"}{"+base+"}= "+ eval(String(pp+"/"+base)).toFixed(2)+'\\]';
                tempp+="\\[cosec\\theta=\\frac{h}{p} =\\frac{"+hyp+"}{"+pp+"}= "+ eval(String(hyp+"/"+pp)).toFixed(2)+'\\]';
...
function solveintegral() {
        ...
        function solveperisq(){
            var oi=document.getElementById("inputsqside").value;
            if(oi==''){
                document.getElementById("resultofperisq").innerHTML='';
            }else{
                sol=eval(String(4)+'*'+String(oi));
                temp='4 x ( '+oi+' ) = '+sol+'<br>';
                temp+='Therefore,Perimeter of Square is '+sol;
        ...
        function solveareasq(){
            ...
            if(oi==''){
                ...
                sol=eval(String(oi)+'*'+String(oi));
                temp=oi+' x '+oi+' = '+sol+'<br>';
                temp+='Therefore,Area of Square is '+sol;
        ...
        function printmorefactors(input,output){
            ...
            for (jk of ar){
            var nnuumm2=jk;
            var getnu="Prime Factors of "+nnuumm2+" is ";
            for(i=2;i<=nnuumm2;i++){
                var j=true;
                while (j==true){
                    if((nnuumm2%i)==0){
        ...
        document.getElementById(output).innerHTML+=getnu+"<b><br>[&nbsp;&nbsp;&nbsp;</b>"+temp+"<b>]</b><br><br>";
        temp+="<br>"
        temp="";
        }
        }
...
<!--        hcf start-->
            function hcf() {
            var ar=[];
            var ll=document.getElementById("num22").value;
            if (ll.includes(" ")){
                ll=ll.split(" ")
                var flag=0;
                for (kj of ll){
                ...
                flag=1;
                ar.push(parseInt(document.getElementById("num22").value));
            }
            input=ar;
  ...
  var len, a, b;
    ...
    if(flag==1){
        document.getElementById("result22").innerHTML+=" HCF is <st>"+a+"</st>";
    }
    else{
    var hcffac=printhcffactor(a,'result22');
    	if (hcffac==" "){
    	    hcffac="1 "
    	}
    	document.getElementById("result22").innerHTML=hcffac+" are in Common.Therefore,";
...
//            document.getElementById('checkdivisibility').appendChild(btn);
    ...
    document.getElementById('resultlcms').innerHTML="";
                var num=document.getElementById('numlcm').value;
                num=num.split(' ');
            ...
            function multiplywithsteps(numm,withnum){
                    ...
                    function showdivisionstepsforcheckdivisibility(){
                       ...
                       for (a = 1; a <= tableNumRows; a++) {
                           ...
                           for (b = 1; b <= tableNumColumns; b++) {
                               tableBody += '<td style="padding: 7px; border:1px solid #ff00cc ;"></td>';
                           }
                           tableBody += '</tr>';
                       }
                   ...
                   function bodyload(){
                    ...
                    function rectanglesolve(){
                        ...
                        var resultother=document.getElementById('resultotherrec');
                        if(length!='' && breadth !=''){
                            resultarea.innerHTML=length+" &times; "+breadth+" = "+eval(String(length)+'*'+String(breadth));
                            resultarea.innerHTML+="<br>Therefore,Area of Rectangle is "+eval(String(length)+'*'+String(breadth));

                            resultperi.innerHTML="2( "+length+" + "+breadth+" ) = 2( "+eval(String(length)+'+'+String(breadth))+" ) = "+eval('2*('+String(length)+'+'+String(breadth)+")");
                            resultperi.innerHTML+="<br>Therefore,Perimeter of Rectangle is "+eval('2*('+String(length)+'+'+String(breadth)+")");
                        }
                        else{
